...
#ifndef FLDSERVER_RECORDER_CSV_H
#define FLDSERVER_RECORDER_CSV_H
...
public:
    ...
    bool
    Open(std::string output_file_name,
         bool is_sequence,
    ...
    bool
    OpenForJsonOnly(bool is_sequence,
                    bool output_2D_landmarks,
                    bool output_3D_landmarks,
                    bool output_model_params,
                    bool output_pose,
    ...
    isOpen() const
    {
        return output_file.is_open() || json_only_;
    }
...
private:
    ...
    RecorderCSV&
    operator=(const RecorderCSV& other);
    RecorderCSV&
    operator=(const RecorderCSV&& other);
...
#endif  // FLDSERVER_RECORDER_CSV_H