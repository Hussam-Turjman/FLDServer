...
#define COMPONENT_EXPORT(component)                                                                \
    COMPONENT_MACRO_CONDITIONAL_(                                                                  \
            IS_##component##_IMPL, COMPONENT_EXPORT_ANNOTATION, COMPONENT_IMPORT_ANNOTATION)
...
// expected.
#define INSIDE_COMPONENT_IMPL(component) COMPONENT_MACRO_CONDITIONAL_(IS_##component##_IMPL, 1, 0)
...
#define COMPONENT_MACRO_CONDITIONAL_COMMA_IMPL_(x, ...) COMPONENT_MACRO_CONDITIONAL_COMMA_##x##_
