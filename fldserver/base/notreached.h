...
#define NOTREACHED()                                                                               \
    true ? ::logging::LogErrorNotReached(__FILE__, __LINE__) : EAT_CHECK_STREAM_PARAMS()
#else
...
#define NOTIMPLEMENTED()                                                                           \
    ::logging::CheckError::NotImplemented(                                                         \
            __FILE__, __LINE__, __FUNCTION__ /*__PRETTY_FUNCTION__ FIXME not supported by msvc */) \
            .stream()
#else
