...
#include "fldserver/base/barrier_closure.h"
...
BarrierInfo::BarrierInfo(int num_callbacks, OnceClosure done_closure) :
    num_callbacks_left_(num_callbacks), done_closure_(std::move(done_closure))
{
}
...
RepeatingClosure
BarrierClosure(int num_callbacks_left, OnceClosure done_closure)
{
