...
// static
void
AtExitManager::RegisterCallback(AtExitCallbackType func, void* param)
{
    DCHECK(func);
...
// static
void
AtExitManager::RegisterTask(base::OnceClosure task)
{
    if (!g_top_manager)
    {
...
void
AtExitManager::DisableAllAtExitManagers()
{
    AutoLock lock(g_top_manager->lock_);
