...
#include "fldserver/base/util/values/values_util.h"
...
base::Value
Int64ToValue(int64_t integer)
{
    return base::Value(base::NumberToString(integer));
}

base::Optional<int64_t>
ValueToInt64(const base::Value* value)
{
...
base::Value
TimeDeltaToValue(base::TimeDelta time_delta)
{
    return Int64ToValue(time_delta.InMicroseconds());
}

base::Optional<base::TimeDelta>
ValueToTimeDelta(const base::Value* value)
{
...
base::Value
TimeToValue(base::Time time)
{
    return TimeDeltaToValue(time.ToDeltaSinceWindowsEpoch());
}

base::Optional<base::Time>
ValueToTime(const base::Value* value)
{
...
base::Value
FilePathToValue(base::FilePath file_path)
{
    return base::Value(file_path.AsUTF8Unsafe());
}

base::Optional<base::FilePath>
ValueToFilePath(const base::Value* value)
{
...
base::Value
UnguessableTokenToValue(base::UnguessableToken token)
{
...
ValueToUnguessableToken(const base::Value* value)
{
