...
public:
    ...
    WallClockTimer&
    operator=(const WallClockTimer&) = delete;
    ...
    virtual void
    Start(const base::Location& posted_from,
    ...
    {
        Start(posted_from, desired_run_time, base::BindOnce(method, base::Unretained(receiver)));
    }
