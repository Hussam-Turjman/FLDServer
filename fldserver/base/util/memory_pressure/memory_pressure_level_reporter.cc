...
#include "fldserver/base/util/memory_pressure/memory_pressure_level_reporter.h"
...
void
MemoryPressureLevelReporter::OnMemoryPressureLevelChanged(MemoryPressureLevel new_level)
{
    ...
    if ((new_level != current_pressure_level_)
        && (current_pressure_level_ != MemoryPressureLevel::MEMORY_PRESSURE_LEVEL_NONE))
    {
        ...
        switch (current_pressure_level_)
        {
            ...
            case MemoryPressureLevel::MEMORY_PRESSURE_LEVEL_MODERATE: {
                ...
                {  // MemoryPressureLevel::MEMORY_PRESSURE_LEVEL_CRITICAL
                    histogram_name = base::StrCat({kHistogramPrefix, "ModerateToCritical"});
                }
                break;
            }
            // From:
            case MemoryPressureLevel::MEMORY_PRESSURE_LEVEL_CRITICAL: {
                ...
                {  // MemoryPressureLevel::MEMORY_PRESSURE_LEVEL_MODERATE
                    histogram_name = base::StrCat({kHistogramPrefix, "CriticalToModerate"});
                }
                break;
            }
...
void
MemoryPressureLevelReporter::ReportHistogram(base::TimeTicks now)
{
    ...
    auto accumulated_seconds = accumulator_buckets_[current_pressure_level_].InSeconds();
    ...
    if (duration_s)
    {
        ...
        // |AddCount|.
        base::LinearHistogram::FactoryGet("Memory.PressureLevel2",
                                          1,
                                          MemoryPressureLevel::kMaxValue + 1,
...
void
MemoryPressureLevelReporter::StartPeriodicTimer()
{
