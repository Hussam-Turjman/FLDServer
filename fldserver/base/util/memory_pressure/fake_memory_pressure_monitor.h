...
namespace test
{
class FakeMemoryPressureMonitor : public ::util::MultiSourceMemoryPressureMonitor
{
public:
    using MemoryPressureLevel = ::util::MultiSourceMemoryPressureMonitor::MemoryPressureLevel;
    using DispatchCallback = ::util::MultiSourceMemoryPressureMonitor::DispatchCallback;

    FakeMemoryPressureMonitor();
    ~FakeMemoryPressureMonitor() override;

    void
    SetAndNotifyMemoryPressure(MemoryPressureLevel level);
