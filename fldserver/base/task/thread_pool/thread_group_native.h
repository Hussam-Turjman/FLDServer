...
namespace internal
{
class CORE_EXPORT ThreadGroupNative : public ThreadGroup
{
public:
    ThreadGroupNative(const ThreadGroupNative&) = delete;
    ThreadGroupNative&
    operator=(const ThreadGroupNative&) = delete;
    ...
    void
    Start(WorkerEnvironment worker_environment = WorkerEnvironment::NONE);
