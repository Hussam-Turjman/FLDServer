...
class CORE_EXPORT TaskSourceSortKey final
{
public:
    TaskSourceSortKey() = default;
    TaskSourceSortKey(TaskPriority priority, TimeTicks ready_time, uint8_t worker_count = 0);
    ...
    bool
    operator<=(const TaskSourceSortKey& other) const;

    bool
    operator==(const TaskSourceSortKey& other) const
    {
        return priority_ == other.priority_ && worker_count_ == other.worker_count_
