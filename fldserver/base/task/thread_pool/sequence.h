...
class CORE_EXPORT Sequence : public TaskSource
{
public:
    ...
    class CORE_EXPORT Transaction : public TaskSource::Transaction
    {
    public:
        ...
        // new Task.
        bool
        WillPushTask() const WARN_UNUSED_RESULT;
        ...
        sequence() const
        {
            return static_cast<Sequence*>(task_source());
        }
