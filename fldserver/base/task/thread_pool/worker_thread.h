...
class CORE_EXPORT WorkerThread : public RefCountedThreadSafe<WorkerThread>,
...
public:
    ...
    public:
        ...
        virtual void
        DidProcessTask(RegisteredTaskSource task_source) = 0;
        ...
        // WorkerThread::WakeUp()
        virtual void
        WaitForWork(WaitableEvent* wake_up_event);
        ...
        virtual void
        OnMainExit(WorkerThread* worker)
        {
        }

        static constexpr TimeDelta kPurgeThreadCacheIdleDelay = TimeDelta::FromSeconds(1);
    };
    ...
    WorkerThread&
    operator=(const WorkerThread&) = delete;
