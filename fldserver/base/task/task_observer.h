...
class CORE_EXPORT TaskObserver
{
public:
    ...
    virtual void
    WillProcessTask(const PendingTask& pending_task, bool was_blocked_or_low_priority) = 0;

    // This method is called after processing a task.
    virtual void
    DidProcessTask(const PendingTask& pending_task) = 0;
