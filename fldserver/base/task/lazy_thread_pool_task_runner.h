...
class CORE_EXPORT LazyThreadPoolTaskRunner;
}  // namespace internal
...
#define LAZY_TASK_RUNNER_CONCATENATE_INTERNAL(a, b) LAZY_TASK_RUNNER_CONCATENATE_INTERNAL2(a, b)
...
#define LAZY_THREAD_POOL_SEQUENCED_TASK_RUNNER_INITIALIZER(traits)                                 \
    ...
    ALLOW_UNUSED_TYPE constexpr base::TaskTraits LAZY_TASK_RUNNER_CONCATENATE_INTERNAL(            \
...
#define LAZY_THREAD_POOL_SINGLE_THREAD_TASK_RUNNER_INITIALIZER(traits, thread_mode)                \
    base::LazyThreadPoolSingleThreadTaskRunner::CreateInternal(traits, thread_mode);               \
    ALLOW_UNUSED_TYPE constexpr base::TaskTraits LAZY_TASK_RUNNER_CONCATENATE_INTERNAL(            \
            kVerifyTraitsAreConstexpr, __LINE__) = traits;                                         \
    ALLOW_UNUSED_TYPE constexpr base::SingleThreadTaskRunnerThreadMode                             \
            LAZY_TASK_RUNNER_CONCATENATE_INTERNAL(kVerifyThreadModeIsConstexpr, __LINE__) =        \
                    thread_mode
...
public:
    ...
    static constexpr LazyThreadPoolTaskRunner
    CreateInternal(
...
private:
    constexpr LazyThreadPoolTaskRunner(const TaskTraits& traits,
    ...
    static TaskRunnerType*
    CreateRaw(void* void_self);
...
class CORE_EXPORT ScopedLazyTaskRunnerListForTesting
{
public:
...
private:
    ...
    void
    AddCallback(OnceClosure callback);
