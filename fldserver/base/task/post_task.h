...
bool
PostTaskAndReplyWithResult(const Location& from_here,
                           const TaskTraits& traits,
...
CORE_EXPORT scoped_refptr<TaskRunner>
...
CORE_EXPORT scoped_refptr<SequencedTaskRunner>
...
CORE_EXPORT scoped_refptr<SingleThreadTaskRunner>
...
template <class T>
bool
DeleteSoon(const Location& from_here, const TaskTraits& traits, const T* object)
{
    return CreateSequencedTaskRunner(traits)->DeleteSoon(from_here, object);
}
template <class T>
bool
DeleteSoon(const Location& from_here, const TaskTraits& traits, std::unique_ptr<T> object)
{
    return DeleteSoon(from_here, traits, object.release());
}
template <class T>
void
ReleaseSoon(const Location& from_here, const TaskTraits& traits, scoped_refptr<T>&& object)
{
