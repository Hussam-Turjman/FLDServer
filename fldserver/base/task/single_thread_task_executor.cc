...
#include "fldserver/base/task/single_thread_task_executor.h"
...
SingleThreadTaskExecutor::SingleThreadTaskExecutor(MessagePumpType type,
    ...
    sequence_manager_(sequence_manager::CreateUnboundSequenceManager(
            sequence_manager::SequenceManager::Settings::Builder()
                    ...
                    .Build())),
    default_task_queue_(sequence_manager_->CreateTaskQueue(sequence_manager::TaskQueue::Spec("defau"
                                                                                             "lt_"
                                                                                             "t"
                                                                                             "q"))),
    type_(type),
...
void
SingleThreadTaskExecutor::SetWorkBatchSize(size_t work_batch_size)
{
