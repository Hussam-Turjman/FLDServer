...
extern const CORE_EXPORT Feature kMayBlockWithoutDelay;

// Under this feature, ThreadPool::ShouldYield() always returns false
extern const CORE_EXPORT Feature kDisableJobYield;
...
extern const CORE_EXPORT Feature kDisableFairJobScheduling;
// Under this feature, priority update on Jobs is disabled.
extern const CORE_EXPORT Feature kDisableJobUpdatePriority;
// Under this feature, another WorkerThread is signaled only after the current
// thread was assigned work.
extern const CORE_EXPORT Feature kWakeUpAfterGetWork;
...
extern const CORE_EXPORT Feature kWakeUpStrategyFeature;
extern const CORE_EXPORT base::FeatureParam<WakeUpStrategy> kWakeUpStrategyParam;
