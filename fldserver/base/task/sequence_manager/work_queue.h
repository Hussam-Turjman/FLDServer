...
public:
    ...
    WorkQueue&
    operator=(const WorkQueue&) = delete;
    ~WorkQueue();
    ...
    void
    AssignSetIndex(size_t work_queue_set_index);
    ...
    bool
    GetFrontTaskEnqueueOrder(EnqueueOrder* enqueue_order) const;
    ...
    void
    PushNonNestableTaskToFront(Task task);
    ...
    WorkQueueSets*
    work_queue_sets() const
    {
        return work_queue_sets_;
    }

    size_t
    work_queue_set_index() const
    {
        return work_queue_set_index_;
    }
    ...
    void
    set_heap_handle(base::internal::HeapHandle handle)
    {
        heap_handle_ = handle;
    }
    ...
    bool
    ShouldRunBefore(const WorkQueue* other_queue) const;
    ...
    bool
    InsertFence(EnqueueOrder fence);
    ...
    void
    InsertFenceSilently(EnqueueOrder fence);
    ...
    // |result|.
    void
    CollectTasksOlderThan(EnqueueOrder reference, std::vector<const Task*>* result) const;

private:
    bool
    InsertFenceImpl(EnqueueOrder fence);
