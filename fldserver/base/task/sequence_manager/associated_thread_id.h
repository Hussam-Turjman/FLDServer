...
// the various methods.
class CORE_EXPORT AssociatedThreadId : public base::RefCountedThreadSafe<AssociatedThreadId>
{
public:
    AssociatedThreadId();
    ...
    static scoped_refptr<AssociatedThreadId>
    CreateUnbound()
    {
    ...
    Optional<PlatformThreadId>
    GetBoundThreadId() const
    {
    ...
    {
        return thread_id_.load(std::memory_order_relaxed) == PlatformThread::CurrentId();
    }
