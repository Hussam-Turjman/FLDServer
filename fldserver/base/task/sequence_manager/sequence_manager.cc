...
SequenceManager::MetricRecordingSettings::MetricRecordingSettings(
    ...
    task_sampling_rate_for_recording_cpu_time(
            base::ThreadTicks::IsSupported() ? task_thread_time_sampling_rate : 0)
{
}
...
SequenceManager::Settings::Builder::SetMessagePumpType(MessagePumpType message_loop_type_val)
{
...
SequenceManager::Settings::Builder&
SequenceManager::Settings::Builder::SetAddQueueTimeToTasks(bool add_queue_time_to_tasks_val)
{
...
SequenceManager::Settings::Builder&
SequenceManager::Settings::Builder::SetTaskLogging(TaskLogging task_execution_logging_val)
{
...
SequenceManager::Settings::Builder&
SequenceManager::Settings::Builder::SetLogTaskDelayExpiry(bool log_task_delay_expiry_val)
{
...
{
    settings_.per_priority_cross_thread_task_delay = per_priority_cross_thread_task_delay_val;
    return *this;
}
...
{
    settings_.per_priority_same_thread_task_delay = per_priority_same_thread_task_delay_val;
    return *this;
}

SequenceManager::Settings::Builder&
SequenceManager::Settings::Builder::SetRandomTaskSelectionSeed(int random_task_selection_seed_val)
{
