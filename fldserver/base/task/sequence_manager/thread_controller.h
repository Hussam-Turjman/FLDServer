...
public:
    ...
    // main message loop.
    virtual void
    SetWorkBatchSize(int work_batch_size = 1) = 0;
    ...
    virtual void
    WillQueueTask(PendingTask* pending_task, const char* task_queue_name) = 0;
    ...
    virtual void
    SetNextDelayedDoWork(LazyNow* lazy_now, TimeTicks run_time) = 0;
    ...
    virtual void
    SetSequencedTaskSource(SequencedTaskSource*) = 0;
    ...
    virtual bool
    RunsTasksInCurrentSequence() = 0;
    virtual const TickClock*
    GetClock() = 0;
    virtual scoped_refptr<SingleThreadTaskRunner>
    GetDefaultTaskRunner() = 0;
    virtual void
    RestoreDefaultTaskRunner() = 0;
    virtual void
    AddNestingObserver(RunLoop::NestingObserver* observer) = 0;
    virtual void
    RemoveNestingObserver(RunLoop::NestingObserver* observer) = 0;
    virtual const scoped_refptr<AssociatedThreadId>&
    GetAssociatedThread() const = 0;
...
protected:
    ...
    class CORE_EXPORT RunLevelTracker
    {
    public:
        enum State
        {
        ...
        void
        OnRunLoopStarted(State initial_state);
        void
        OnRunLoopEnded();
        void
        OnTaskStarted();
        ...
        public:
            ...
            virtual void
            OnThreadControllerActiveBegin() = 0;
            virtual void
            OnThreadControllerActiveEnd() = 0;
        };

        static void
        SetTraceObserverForTesting(TraceObserverForTesting* trace_observer_for_testing);
