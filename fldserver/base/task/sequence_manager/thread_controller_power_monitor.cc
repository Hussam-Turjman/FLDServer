...
const Feature kUsePowerMonitorWithThreadController{"UsePowerMonitorWithThreadController",
...
void
ThreadControllerPowerMonitor::BindToCurrentThread()
{
...
bool
ThreadControllerPowerMonitor::IsProcessInPowerSuspendState()
{
...
// static
void
ThreadControllerPowerMonitor::InitializeOnMainThread()
{
...
// static
void
ThreadControllerPowerMonitor::OverrideUsePowerMonitorForTesting(bool use_power_monitor)
{
...
void
ThreadControllerPowerMonitor::OnSuspend()
{
...
void
ThreadControllerPowerMonitor::OnResume()
{
    if (!g_use_thread_controller_power_monitor_)
        return;
