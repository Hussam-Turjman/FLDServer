...
public:
    ...
    static bool
    PostTask(const Location& from_here, OnceClosure task);
    inline static bool
    PostTask(OnceClosure task, const Location& from_here = Location::Current())
    {
    ...
    static bool
    PostDelayedTask(const Location& from_here, OnceClosure task, TimeDelta delay);
    ...
    static scoped_refptr<TaskRunner>
    ...
    static scoped_refptr<SingleThreadTaskRunner>
