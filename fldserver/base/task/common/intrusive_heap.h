...
#include "fldserver/base/containers/intrusive_heap.h"
...
public:
    ...
    IntrusiveHeap&
    operator=(IntrusiveHeap&& other) = default;

    bool
    empty() const
    {
        return IntrusiveHeapImplType::empty();
    }
    size_t
    size() const
    {
        return IntrusiveHeapImplType::size();
    }
    ...
    Min() const
    {
        return IntrusiveHeapImplType::top();
    }
    void
    Pop()
    {
        IntrusiveHeapImplType::pop();
    }
    ...
    void
    erase(HeapHandle handle)
    {
        IntrusiveHeapImplType::erase(handle);
    }

    void
    ReplaceMin(T&& element)
    {
        IntrusiveHeapImplType::ReplaceTop(std::move(element));
    }

    void
    ChangeKey(HeapHandle handle, T&& element)
    {
        IntrusiveHeapImplType::Replace(handle, std::move(element));
    }

    const T&
    at(HeapHandle handle) const
    {
    ...
    begin() const
    {
        return IntrusiveHeapImplType::data();
    }
    const T*
    end() const
    {
        return IntrusiveHeapImplType::data() + size();
    }
};
