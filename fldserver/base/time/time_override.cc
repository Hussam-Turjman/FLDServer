...
ScopedTimeClockOverrides::ScopedTimeClockOverrides(TimeNowFunction time_override,
...
ScopedTimeClockOverrides::~ScopedTimeClockOverrides()
{
    ...
    internal::g_time_now_from_system_time_function = &TimeNowFromSystemTimeIgnoringOverride;
