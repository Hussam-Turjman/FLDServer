...
#if defined(OS_NACL)
#include "fldserver/base/os_compat_nacl.h"
#endif
...
{
    const int64_t millis_since_unix_epoch = ToRoundedDownMillisecondsSinceUnixEpoch();
