...
namespace
{
LazyInstance<ThreadLocalPointer<SequencedTaskRunnerHandle>>::Leaky sequenced_task_runner_tls =
...
{
    const SequencedTaskRunnerHandle* current = sequenced_task_runner_tls.Pointer()->Get();
    CHECK(current) << "Error: This caller requires a sequenced context (i.e. the current "
