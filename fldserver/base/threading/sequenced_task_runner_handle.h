...
class CORE_EXPORT SequencedTaskRunnerHandle
{
public:
    ...
    // the requirements).
    static const scoped_refptr<SequencedTaskRunner>&
    ...
    explicit SequencedTaskRunnerHandle(scoped_refptr<SequencedTaskRunner> task_runner);
