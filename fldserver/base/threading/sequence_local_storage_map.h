...
class CORE_EXPORT SequenceLocalStorageMap
{
public:
    ...
    static SequenceLocalStorageMap&
    GetForCurrentThread();
    ...
    public:
        ...
        ValueDestructorPair&
        operator=(ValueDestructorPair&& value_destructor_pair);
    ...
    void
    Set(int slot_id, ValueDestructorPair value_destructor_pair);
...
class CORE_EXPORT ScopedSetSequenceLocalStorageMapForCurrentThread
{
public:
