...
{
std::ostream&
operator<<(std::ostream& out, const ThreadLocalBoolean& tl)
{
...
public:
    ...
    friend std::ostream&
    operator<<(std::ostream& out, const ThreadLocalBooleanWithStacks& tl)
    {
        out << tl.bool_ << " by ";
...
LazyInstance<ThreadLocalBooleanWithStacks>::Leaky g_blocking_disallowed = LAZY_INSTANCE_INITIALIZER;

LazyInstance<ThreadLocalBooleanWithStacks>::Leaky g_singleton_disallowed =
        LAZY_INSTANCE_INITIALIZER;

LazyInstance<ThreadLocalBooleanWithStacks>::Leaky g_base_sync_primitives_disallowed =
        LAZY_INSTANCE_INITIALIZER;

LazyInstance<ThreadLocalBooleanWithStacks>::Leaky g_cpu_intensive_work_disallowed =
        LAZY_INSTANCE_INITIALIZER;
...
AssertBaseSyncPrimitivesAllowed()
{
    DCHECK(!g_base_sync_primitives_disallowed.Get().Get())
            ...
            << "g_base_sync_primitives_disallowed " << g_base_sync_primitives_disallowed.Get()
...
AssertLongCPUWorkAllowed()
{
    DCHECK(!g_cpu_intensive_work_disallowed.Get().Get())
            << "Function marked as CPU intensive was called from a scope that "
               ...
               "asynchronous.\n"
            << "g_cpu_intensive_work_disallowed " << g_cpu_intensive_work_disallowed.Get();
}
...
// static
bool
ThreadRestrictions::SetIOAllowed(bool allowed)
{
...
// static
bool
ThreadRestrictions::SetSingletonAllowed(bool allowed)
{
...
bool
ThreadRestrictions::SetWaitAllowed(bool allowed)
{
