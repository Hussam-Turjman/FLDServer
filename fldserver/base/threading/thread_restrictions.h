...
bool
PathProviderWin(int, FilePath*);

#if DCHECK_IS_ON()
#define INLINE_IF_DCHECK_IS_OFF CORE_EXPORT
...
INLINE_IF_DCHECK_IS_OFF void
AssertBlockingAllowed() EMPTY_BODY_IF_DCHECK_IS_OFF;

}  // namespace internal

// Disallows blocking on the current thread.
INLINE_IF_DCHECK_IS_OFF void
DisallowBlocking() EMPTY_BODY_IF_DCHECK_IS_OFF;

// Disallows blocking calls within its scope.
class CORE_EXPORT ScopedDisallowBlocking
{
public:
...
class CORE_EXPORT ScopedAllowBlocking
{
private:
...
INLINE_IF_DCHECK_IS_OFF void
DisallowBaseSyncPrimitives() EMPTY_BODY_IF_DCHECK_IS_OFF;

class CORE_EXPORT ScopedAllowBaseSyncPrimitives
{
private:
    ...
    friend class blitz::net::MultiThreadedCertVerifierScopedAllowBaseSyncPrimitives;
    friend class rlz_lib::FinancialPing;
    friend class shell_integration_linux::LaunchXdgUtilityScopedAllowBaseSyncPrimitives;
...
class CORE_EXPORT ScopedAllowBaseSyncPrimitivesOutsideBlockingScope
{
private:
    // This can only be instantiated by friends. Use
    // ScopedAllowBaseSyncPrimitivesForTesting in unit tests to avoid the friend
    ...
    friend class android_webview::AwFormDatabaseService;  // http://crbug.com/904431
    ...
    friend class content::BrowserGpuChannelHostFactory;  // http://crbug.com/125248
    friend class dbus::Bus;                              // http://crbug.com/125222
    friend class disk_cache::BackendImpl;                // http://crbug.com/74623
    friend class disk_cache::InFlightIO;                 // http://crbug.com/74623
    friend class blitz::disk_cache::InFlightIO;
    friend class blitz::disk_cache::BackendImpl;
    ...
    friend class blitz::net::internal::AddressTrackerLinux;
    // friend class net::MultiThreadedProxyResolverScopedAllowJoinOnIO;  // http://crbug.com/69710
    friend class blitz::net::MultiThreadedProxyResolverScopedAllowJoinOnIO;
...
class CORE_EXPORT ScopedAllowBaseSyncPrimitivesForTesting
{
public:
...
class CORE_EXPORT ScopedAllowUnresponsiveTasksForTesting
{
public:
...
// scope.
INLINE_IF_DCHECK_IS_OFF void
AssertBaseSyncPrimitivesAllowed() EMPTY_BODY_IF_DCHECK_IS_OFF;

// Resets all thread restrictions on the current thread.
INLINE_IF_DCHECK_IS_OFF void
ResetThreadRestrictionsForTesting() EMPTY_BODY_IF_DCHECK_IS_OFF;

}  // namespace internal

// Asserts that running long CPU work is allowed in the current scope.
INLINE_IF_DCHECK_IS_OFF void
AssertLongCPUWorkAllowed() EMPTY_BODY_IF_DCHECK_IS_OFF;

INLINE_IF_DCHECK_IS_OFF void
DisallowUnresponsiveTasks() EMPTY_BODY_IF_DCHECK_IS_OFF;

class CORE_EXPORT ThreadRestrictions
{
public:
    ...
    class CORE_EXPORT ScopedAllowIO
    {
    public:
