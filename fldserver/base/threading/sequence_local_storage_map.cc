...
ScopedSetSequenceLocalStorageMapForCurrentThread::ScopedSetSequenceLocalStorageMapForCurrentThread(
...
SequenceLocalStorageMap::GetForCurrentThread()
{
    ...
    DCHECK(current_sequence_local_storage) << "SequenceLocalStorageSlot cannot be used because no "
                                              "SequenceLocalStorageMap was stored in TLS. Use "
                                              "ScopedSetSequenceLocalStorageMapForCurrentThread to "
                                              "store a "
...
// static
bool
SequenceLocalStorageMap::IsSetForCurrentThread()
{
    return tls_current_sequence_local_storage.Get().Get() != nullptr;
}

void*
SequenceLocalStorageMap::Get(int slot_id)
{
...
void
SequenceLocalStorageMap::Set(int slot_id,
...
SequenceLocalStorageMap::ValueDestructorPair::ValueDestructorPair(void* value,
...
SequenceLocalStorageMap::ValueDestructorPair::ValueDestructorPair(
    ...
    value_(value_destructor_pair.value_), destructor_(value_destructor_pair.destructor_)
{
    value_destructor_pair.value_ = nullptr;
}

SequenceLocalStorageMap::ValueDestructorPair&
SequenceLocalStorageMap::ValueDestructorPair::operator=(ValueDestructorPair&& value_destructor_pair)
{
