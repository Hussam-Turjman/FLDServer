...
#include "fldserver/base/threading/watchdog.h"
...
void
Watchdog::ArmSomeTimeDeltaAgo(const TimeDelta& time_delta)
{
...
void
Watchdog::ArmAtStartTime(const TimeTicks start_time)
{
    AutoLock lock(lock_);
...
void
Watchdog::ThreadDelegate::ThreadMain()
{
    SetThreadName();
    ...
    while (1)
    {
        ...
        remaining_duration = watchdog_->duration_ - (TimeTicks::Now() - watchdog_->start_time_);
...
void
Watchdog::ThreadDelegate::SetThreadName() const
{
