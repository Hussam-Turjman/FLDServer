...
{
public:
    SequenceLocalStorageSlot() : slot_id_(internal::GetNextSequenceLocalStorageSlotNumber())
    {
    }
    ...
    operator bool() const
    {
        return GetValuePointer() != nullptr;
    }
    ...
    GetValuePointer()
    {
        void* ptr = internal::SequenceLocalStorageMap::GetForCurrentThread().Get(slot_id_);
...
private:
    ...
    Adopt(T* value_ptr)
    {
        ...
        internal::SequenceLocalStorageMap::ValueDestructorPair::DestructorFunc* destructor =
                [](void* ptr) { Deleter()(static_cast<T*>(ptr)); };

        internal::SequenceLocalStorageMap::ValueDestructorPair value_destructor_pair(value_ptr,
                                                                                     destructor);
