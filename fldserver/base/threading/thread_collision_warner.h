...
#define DFAKE_SCOPED_LOCK(obj)                                                                     \
    base::ThreadCollisionWarner::ScopedCheck DFAKE_UNIQUE_VARIABLE_NAME(s_check_)(&obj)
// Asserts the call is never called simultaneously in two threads. Used at
// member function scope. Same as DFAKE_SCOPED_LOCK but allows recursive locks.
#define DFAKE_SCOPED_RECURSIVE_LOCK(obj)                                                           \
    base::ThreadCollisionWarner::ScopedRecursiveCheck DFAKE_UNIQUE_VARIABLE_NAME(sr_check)(&obj)
...
struct CORE_EXPORT AsserterBase
{
...
struct CORE_EXPORT DCheckAsserter : public AsserterBase
{
...
class CORE_EXPORT ThreadCollisionWarner
{
public:
    ...
    class CORE_EXPORT ScopedRecursiveCheck
    {
    public:
