...
class CORE_EXPORT PlatformThreadLocalStorage
{
public:
#if IS_WIN
    ...
    enum : unsigned
    {
        TLS_KEY_OUT_OF_INDEXES = TLS_OUT_OF_INDEXES
    };
#elif IS_POSIX || defined(OS_FUCHSIA)
    ...
    FreeTLS(TLSKey key);
    static void
    SetTLSValue(TLSKey key, void* value);
    static void*
    GetTLSValue(TLSKey key)
    {
#if IS_WIN
...
class CORE_EXPORT ThreadLocalStorage
{
public:
