...
class CORE_EXPORT ScopedBlockingCall : public internal::UncheckedScopedBlockingCall
{
public:
...
class CORE_EXPORT ScopedBlockingCallWithBaseSyncPrimitives : public UncheckedScopedBlockingCall
{
public:
    ScopedBlockingCallWithBaseSyncPrimitives(const Location& from_here, BlockingType blocking_type);
