...
class CORE_EXPORT SimpleThread : public PlatformThread::Delegate
{
public:
    ...
    public:
        ...
        Options&
        operator=(const Options& other) = default;
...
class CORE_EXPORT DelegateSimpleThread : public SimpleThread
{
public:
...
class CORE_EXPORT DelegateSimpleThreadPool : public DelegateSimpleThread::Delegate
{
public:
    ...
    void
    AddWork(Delegate* work, int repeat_count);
    void
    AddWork(Delegate* work)
    {
        AddWork(work, 1);
    }
