...
{
    size_t
    operator()(const base::Token& token) const
    {
...
CORE_EXPORT void
WriteTokenToPickle(Pickle* pickle, const Token& token);
CORE_EXPORT Optional<Token>
ReadTokenFromPickle(PickleIterator* pickle_iterator);
