...
#if defined(COMPILER_MSVC) && !defined(__clang__) && 0
...
AnalyzerNoReturn() __attribute__((analyzer_noreturn))
{
    return false;
}

inline constexpr bool
AnalyzerAssumeTrue(bool arg)
{
...
#if defined(__clang__) && __has_attribute(nomerge) && 0
