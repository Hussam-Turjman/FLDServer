...
class CORE_EXPORT SupportsUserData
{
public:
    SupportsUserData();
    SupportsUserData(SupportsUserData&&);
    SupportsUserData&
    operator=(SupportsUserData&&);
    SupportsUserData(const SupportsUserData&) = delete;
    SupportsUserData&
    operator=(const SupportsUserData&) = delete;
    ...
    // RemoveUserData().
    Data*
    GetUserData(const void* key) const;
    void
    SetUserData(const void* key, std::unique_ptr<Data> data);
    void
    RemoveUserData(const void* key);
    ...
    void
    CloneDataFrom(const SupportsUserData& other);
...
public:
    static T*
    Get(const SupportsUserData* supports_user_data, const void* key)
    {
    ...
    UserDataAdapter&
    operator=(const UserDataAdapter&) = delete;
