...
#include "fldserver/base/hash/legacy_hash.h"

#include "fldserver/base/cityhash_v103/src/city_v103.h"
...
{
    return internal::cityhash_v103::CityHash64(reinterpret_cast<const char*>(data.data()),
                                               data.size());
}
