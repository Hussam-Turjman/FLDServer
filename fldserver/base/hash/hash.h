...
CORE_EXPORT uint32_t
PersistentHash(base::span<const uint8_t> data);
CORE_EXPORT uint32_t
...
HashInts(T1 value1, T2 value2)
{
    ...
    return HashInts32(static_cast<uint32_t>(value1), static_cast<uint32_t>(value2));
}
...
{
    size_t
    operator()(std::pair<Type1, Type2> value) const
    {
