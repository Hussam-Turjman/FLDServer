...
class CORE_EXPORT TaskRunner : public RefCountedThreadSafe<TaskRunner, TaskRunnerTraits>
{
public:
    ...
    virtual bool
    PostDelayedTask(const Location& from_here, OnceClosure task, base::TimeDelta delay) = 0;
...
struct CORE_EXPORT TaskRunnerTraits
{
    static void
    Destruct(const TaskRunner* task_runner);
};
