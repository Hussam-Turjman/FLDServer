...
WaitableEvent::WaitableEvent(win::ScopedHandle handle) : handle_(std::move(handle))
{
...
// static
size_t
WaitableEvent::WaitMany(WaitableEvent** events, size_t count)
{
