...
class CORE_EXPORT WaitableEvent
{
public:
    ...
    bool NOT_TAIL_CALLED
    TimedWait(const TimeDelta& wait_delta);
    ...
    static size_t NOT_TAIL_CALLED
    WaitMany(WaitableEvent** waitables, size_t count);
    ...
    public:
        ...
        // been notified.
        virtual bool
        Fire(WaitableEvent* signaling_event) = 0;
...
private:
    ...
    static bool
    UseSlowWatchList(ResetPolicy policy);
    ...
    static bool
    PeekPort(mach_port_t port, bool dequeue);
    ...
    public:
        ...
        bool
        Dequeue(Waiter* waiter, void* tag);
    ...
    // unsorted, array.
    static size_t
    EnqueueMany(WaiterAndIndex* waitables, size_t count, Waiter* waiter);
