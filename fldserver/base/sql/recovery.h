...
public:
    ...
    static std::unique_ptr<Recovery>
    Begin(Database* database, const base::FilePath& db_path) WARN_UNUSED_RESULT;
    ...
    static void
    Rollback(std::unique_ptr<Recovery> r);
    ...
    bool
    AutoRecoverTable(const char* table_name, size_t* rows_recovered);
    ...
    bool
    GetMetaVersionNumber(int* version_number);
    ...
    static std::unique_ptr<Recovery>
    BeginRecoverDatabase(Database* db, const base::FilePath& db_path) WARN_UNUSED_RESULT;
    ...
    static void
    RecoverDatabase(Database* db, const base::FilePath& db_path);
    ...
    static void
    RecoverDatabaseWithMetaVersion(Database* db, const base::FilePath& db_path);
...
private:
    ...
    bool
    Init(const base::FilePath& db_path) WARN_UNUSED_RESULT;

    // Copy the recovered database over the original database.
    bool
    Backup() WARN_UNUSED_RESULT;
