...
public:
    ...
    // lives.
    static std::pair<int, std::unique_ptr<VirtualTable>>
    Create(sqlite3* sqlite_db,
    ...
    VirtualTable&
    operator=(const VirtualTable&) = delete;
    ...
    const std::vector<RecoveredColumnSpec>
    column_specs() const
    {
    ...
    static inline VirtualTable*
    FromSqliteTable(sqlite3_vtab* sqlite_table)
    {
    ...
    void
    WillDeleteCursor(VirtualCursor* cursor);
