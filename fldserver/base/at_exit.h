...
class CORE_EXPORT AtExitManager
{
public:
    ...
    AtExitManager&
    operator=(const AtExitManager&) = delete;
    ...
    static void
    RegisterCallback(AtExitCallbackType func, void* param);

    // Registers the specified task to be called at exit.
    static void
    RegisterTask(base::OnceClosure task);
