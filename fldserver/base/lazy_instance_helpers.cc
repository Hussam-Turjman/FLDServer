...
{
bool
NeedsLazyInstance(subtle::AtomicWord* state)
{
    ...
    if (subtle::NoBarrier_CompareAndSwap(state, 0, kLazyInstanceStateCreating) == 0)
    {
...
void
CompleteLazyInstance(subtle::AtomicWord* state,
