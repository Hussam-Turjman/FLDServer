...
constexpr bool
IsLowerHexDigit(Char c)
{
    return (c >= '0' && c <= '9') || (c >= 'a' && c <= 'f');
}

constexpr bool
IsHyphenPosition(size_t i)
{
...
std::string
GetCanonicalGUIDInternal(StringPieceType input, bool strict)
{
...
bool
IsValidGUID(StringPiece input)
{
    return !GetCanonicalGUIDInternal(input, /*strict=*/false).empty();
}

bool
IsValidGUID(StringPiece16 input)
{
    return !GetCanonicalGUIDInternal(input, /*strict=*/false).empty();
}

bool
IsValidGUIDOutputString(StringPiece input)
{
    return !GetCanonicalGUIDInternal(input, /*strict=*/true).empty();
}

std::string
RandomDataToGUIDString(const uint64_t bytes[2])
{
...
// static
GUID
GUID::ParseCaseInsensitive(StringPiece input)
{
    GUID guid;
...
// static
GUID
GUID::ParseCaseInsensitive(StringPiece16 input)
{
    GUID guid;
    guid.lowercase_ = GetCanonicalGUIDInternal(input, /*strict=*/false);
    return guid;
...
// static
GUID
GUID::ParseLowercase(StringPiece input)
{
    GUID guid;
...
// static
GUID
GUID::ParseLowercase(StringPiece16 input)
{
    GUID guid;
    guid.lowercase_ = GetCanonicalGUIDInternal(input, /*strict=*/true);
    return guid;
