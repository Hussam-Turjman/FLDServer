...
struct CORE_EXPORT NativeLibraryLoadError
{
#if IS_WIN
...
struct CORE_EXPORT NativeLibraryOptions
{
...
CORE_EXPORT NativeLibrary
LoadNativeLibrary(const FilePath& library_path, NativeLibraryLoadError* error);
