...
#include "fldserver/base/memory/tagging.h"
...
{
void
ChangeMemoryTaggingModeInternal(unsigned prctl_mask)
{
    base::CPU cpu;
    if (cpu.has_mte())
    {
...
void
ChangeMemoryTaggingModeForCurrentThread(TagViolationReportingMode m)
{
#if defined(HAS_MEMORY_TAGGING)
