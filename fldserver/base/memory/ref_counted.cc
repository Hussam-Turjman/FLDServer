...
{
bool
RefCountedThreadSafeBase::HasOneRef() const
{
    return ref_count_.IsOne();
}

bool
RefCountedThreadSafeBase::HasAtLeastOneRef() const
{
...
void
RefCountedBase::AddRefImpl() const
{
...
void
RefCountedBase::ReleaseImpl() const
{
...
bool
RefCountedThreadSafeBase::Release() const
{
    return ReleaseImpl();
}
void
RefCountedThreadSafeBase::AddRef() const
{
    AddRefImpl();
}
void
RefCountedThreadSafeBase::AddRefWithCheck() const
{
    AddRefWithCheckImpl();
}
#endif
...
#if DCHECK_IS_ON()
bool
RefCountedBase::CalledOnValidSequence() const
{
