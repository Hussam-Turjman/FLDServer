...
//     races.
//
class CORE_EXPORT DiscardableMemory
{
public:
    DiscardableMemory();
    ...
    /* virtual trace_event::MemoryAllocatorDump*
     CreateMemoryAllocatorDump(const char* name, trace_event::ProcessMemoryDump* pmd) const = 0;*/
};

enum class DiscardableMemoryBacking
{
    kSharedMemory,
    kMadvFree
};
CORE_EXPORT DiscardableMemoryBacking
