...
// static
void
DiscardableMemoryAllocator::SetInstance(DiscardableMemoryAllocator* allocator)
{
...
DiscardableMemoryAllocator::AllocateLockedDiscardableMemoryWithRetryOrDie(size_t size,
