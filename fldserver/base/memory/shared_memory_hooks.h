...
int
CloudPrintServiceProcessMain(const content::MainFunctionParams& parameters);
...
private:
    ...
    friend int ::CloudPrintServiceProcessMain(const content::MainFunctionParams& parameters);
    ...
    static void
    SetCreateHooks(ReadOnlySharedMemoryRegion::CreateFunction* read_only_hook,
