...
class CORE_EXPORT RefCountedMemory : public RefCountedThreadSafe<RefCountedMemory>
{
public:
    ...
    bool
    Equals(const scoped_refptr<RefCountedMemory>& other) const;
...
// matter.
class CORE_EXPORT RefCountedStaticMemory : public RefCountedMemory
{
public:
    ...
    RefCountedStaticMemory(const void* data, size_t length) :
        data_(static_cast<const unsigned char*>(length ? data : nullptr)), length_(length)
    {
    }
...
// vector.
class CORE_EXPORT RefCountedBytes : public RefCountedMemory
{
public:
    RefCountedBytes();
...
class CORE_EXPORT RefCountedString : public RefCountedMemory
{
public:
    RefCountedString();
...
// std::u16string.
class CORE_EXPORT RefCountedString16 : public base::RefCountedMemory
{
public:
    RefCountedString16();

    // Constructs a RefCountedString16 object by performing a swap.
    static scoped_refptr<RefCountedString16>
    TakeString(std::u16string* to_destroy);
...
class CORE_EXPORT RefCountedSharedMemoryMapping : public RefCountedMemory
{
public:
    ...
    static scoped_refptr<RefCountedSharedMemoryMapping>
    CreateFromWholeRegion(const ReadOnlySharedMemoryRegion& region);
