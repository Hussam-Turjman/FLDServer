...
public:
    ...
    void
    AddObserver(MemoryPressureListener* listener, bool sync)
    {
    ...
    void
    RemoveObserver(MemoryPressureListener* listener)
    {
    ...
    void
    Notify(MemoryPressureListener::MemoryPressureLevel memory_pressure_level)
    {
        async_observers_->Notify(FROM_HERE, &MemoryPressureListener::Notify, memory_pressure_level);
        AutoLock lock(sync_observers_lock_);
...
private:
    const scoped_refptr<ObserverListThreadSafe<MemoryPressureListener>> async_observers_ =
...
MemoryPressureListener::MemoryPressureListener(
        const base::Location& creation_location,
        const MemoryPressureListener::MemoryPressureCallback& callback,
        const MemoryPressureListener::SyncMemoryPressureCallback& sync_memory_pressure_callback) :
    callback_(callback),
...
void
MemoryPressureListener::Notify(MemoryPressureLevel memory_pressure_level)
{
    callback_.Run(memory_pressure_level);
}

void
MemoryPressureListener::SyncNotify(MemoryPressureLevel memory_pressure_level)
{
...
// static
void
MemoryPressureListener::NotifyMemoryPressure(MemoryPressureLevel memory_pressure_level)
{
    ...
    /*TRACE_EVENT_INSTANT(
            ...
            [&](perfetto::EventContext ctx) {
                ...
                data->set_level(trace_event::MemoryPressureLevelToTraceEnum(memory_pressure_level));
            });*/
...
// static
bool
MemoryPressureListener::AreNotificationsSuppressed()
{
...
// static
void
MemoryPressureListener::SetNotificationsSuppressed(bool suppress)
{
...
// static
void
MemoryPressureListener::SimulatePressureNotification(MemoryPressureLevel memory_pressure_level)
{
...
// static
void
MemoryPressureListener::DoNotifyMemoryPressure(MemoryPressureLevel memory_pressure_level)
{
    DCHECK_NE(memory_pressure_level, MEMORY_PRESSURE_LEVEL_NONE);
