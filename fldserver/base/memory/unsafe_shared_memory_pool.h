...
#include "fldserver/base/types/pass_key.h"
...
class CORE_EXPORT UnsafeSharedMemoryPool : public RefCountedThreadSafe<UnsafeSharedMemoryPool>
{
public:
    // Used to store the allocation result.
    // This class returns memory to the pool upon destruction.
    class CORE_EXPORT Handle
    {
    public:
...
private:
    ...
    void
    ReleaseBuffer(UnsafeSharedMemoryRegion region, WritableSharedMemoryMapping mapping);
