...
{
void
RecordMappingWasBlockedHistogram(bool blocked)
{
...
PlatformSharedMemoryRegion::CreateWritable(size_t size)
{
...
// static
PlatformSharedMemoryRegion
PlatformSharedMemoryRegion::CreateUnsafe(size_t size)
{
...
PlatformSharedMemoryRegion::PlatformSharedMemoryRegion(PlatformSharedMemoryRegion&& other) =
        default;
PlatformSharedMemoryRegion&
PlatformSharedMemoryRegion::operator=(PlatformSharedMemoryRegion&& other) = default;
PlatformSharedMemoryRegion::~PlatformSharedMemoryRegion() = default;
...
bool
PlatformSharedMemoryRegion::MapAt(off_t offset,
                                  size_t size,
                                  void** memory,
