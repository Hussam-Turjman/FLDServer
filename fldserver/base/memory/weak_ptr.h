...
class CORE_EXPORT WeakReference
{
public:
    // Although Flag is bound to a specific SequencedTaskRunner, it may be
    // deleted from another via base::WeakPtr::~WeakPtr().
    class CORE_EXPORT Flag : public RefCountedThreadSafe<Flag>
    {
    public:
        Flag();
    ...
    WeakReference&
    operator=(WeakReference&& other) noexcept = default;
    WeakReference&
    operator=(const WeakReference& other) = default;
...
class CORE_EXPORT WeakReferenceOwner
{
public:
    WeakReferenceOwner();
    ~WeakReferenceOwner();
...
public:
    ...
    WeakPtrBase&
    operator=(const WeakPtrBase& other) = default;
    WeakPtrBase&
    operator=(WeakPtrBase&& other) noexcept = default;
...
public:
    ...
    static WeakPtr<Derived>
    StaticAsWeakPtr(Derived* t)
    {
...
private:
    ...
    static WeakPtr<Derived>
    AsWeakPtrImpl(SupportsWeakPtr<Base>* t)
    {
...
public:
    ...
    bool
    WasInvalidated() const
    {
        return ptr_ && !ref_.IsValid();
    }
...
template <class T>
bool
operator!=(const WeakPtr<T>& weak_ptr, std::nullptr_t)
{
...
namespace internal
{
class CORE_EXPORT WeakPtrFactoryBase
{
protected:
