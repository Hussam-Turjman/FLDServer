...
// or destroyed.
class CORE_EXPORT ReadOnlySharedMemoryRegion
{
public:
    ...
    TakeHandleForSerialization(ReadOnlySharedMemoryRegion region);
    ...
    ReadOnlySharedMemoryRegion&
    operator=(ReadOnlySharedMemoryRegion&&);
    ...
    // handle.
    subtle::PlatformSharedMemoryRegion::PlatformHandle
...
private:
    ...
    explicit ReadOnlySharedMemoryRegion(subtle::PlatformSharedMemoryRegion handle);
