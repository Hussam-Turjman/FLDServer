...
class THREAD_ANNOTATION_ATTRIBUTE__(capability("context")) CORE_EXPORT SequenceCheckerImpl
{
public:
    static void
    EnableStackLogging();
    ...
    // untouched.
    bool
    CalledOnValidSequence(std::unique_ptr<debug::StackTrace>* out_bound_at = nullptr) const
            WARN_UNUSED_RESULT;
