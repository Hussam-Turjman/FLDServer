...
#include "fldserver/nss_util_internal.h"
...
LoadChaps()
{
    ...
    return LoadNSSModule(kChapsModuleName,
                         kChapsPath,
...
bool
IsSlotProvidedByChaps(PK11SlotInfo* slot)
{
    if (!slot)
        return false;
    ...
    return pk11_module
           && base::StringPiece(pk11_module->commonName) == base::StringPiece(kChapsModuleName);
}
