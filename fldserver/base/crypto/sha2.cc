...
namespace crypto
{
std::array<uint8_t, kSHA256Length>
SHA256Hash(base::span<const uint8_t> input)
{
...
void
SHA256HashString(base::StringPiece str, void* output, size_t len)
{
...
std::string
SHA256HashString(base::StringPiece str)
{
