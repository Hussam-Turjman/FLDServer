...
#include "fldserver/base/crypto/signature_verifier.h"
...
public:
    ...
    virtual base::Optional<SignatureVerifier::SignatureAlgorithm>
    SelectAlgorithm(
            base::span<const SignatureVerifier::SignatureAlgorithm> acceptable_algorithms) = 0;
    ...
    virtual std::unique_ptr<UnexportableSigningKey>
    ...
    virtual std::unique_ptr<UnexportableSigningKey>
    FromWrappedSigningKeySlowly(base::span<const uint8_t> wrapped_key) = 0;
};
...
CORE_EXPORT std::unique_ptr<UnexportableKeyProvider>
...
{
CORE_EXPORT void
        SetUnexportableKeyProviderForTesting(std::unique_ptr<UnexportableKeyProvider> (*func)());
