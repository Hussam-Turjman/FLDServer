...
public:
    ...
    // Init() may fail.
    bool
    Init(const unsigned char* key, size_t key_length) WARN_UNUSED_RESULT;

    // Initializes this instance using |key|. Call Init
    // only once. It returns false on the second or later calls.
    bool
    Init(const SymmetricKey* key) WARN_UNUSED_RESULT;

    // Initializes this instance using |key|. Call Init only once. It returns
    // false on the second or later calls.
    bool
    Init(base::StringPiece key) WARN_UNUSED_RESULT
    {
    ...
    // false on the second or later calls.
    bool
    Init(base::span<const uint8_t> key) WARN_UNUSED_RESULT
    {
    ...
    bool
    Sign(base::span<const uint8_t> data, base::span<uint8_t> digest) const WARN_UNUSED_RESULT;
    ...
    bool
    Verify(base::StringPiece data, base::StringPiece digest) const WARN_UNUSED_RESULT;
    bool
    Verify(base::span<const uint8_t> data,
    ...
    bool
    VerifyTruncated(base::StringPiece data, base::StringPiece digest) const WARN_UNUSED_RESULT;
    bool
    VerifyTruncated(base::span<const uint8_t> data,
                    base::span<const uint8_t> digest) const WARN_UNUSED_RESULT;
