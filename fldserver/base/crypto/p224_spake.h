...
class CORE_EXPORT P224EncryptedKeyExchange
{
public:
    enum Result
    {
    ...
    Result
    ProcessMessage(base::StringPiece message);
...
private:
    ...
    void
    SetXForTesting(const std::string& x);
    ...
    void
    CalculateHash(PeerType peer_type,
