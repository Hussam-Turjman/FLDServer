...
CORE_EXPORT bool
GetFieldTrialParamsByFeature(const base::Feature& feature, FieldTrialParams* params);
...
CORE_EXPORT std::string
GetFieldTrialParamValueByFeature(const base::Feature& feature, const std::string& param_name);
...
CORE_EXPORT int
GetFieldTrialParamByFeatureAsInt(const base::Feature& feature,
...
// empty and the conversion does not succeed, it produces a warning to LOG.
CORE_EXPORT double
GetFieldTrialParamByFeatureAsDouble(const base::Feature& feature,
                                    const std::string& param_name,
...
CORE_EXPORT bool
GetFieldTrialParamByFeatureAsBool(const base::Feature& feature,
                                  const std::string& param_name,
                                  bool default_value);
...
{
    constexpr FeatureParam(const Feature* feature, const char* name, const char* default_value) :
...
{
    constexpr FeatureParam(const Feature* feature, const char* name, double default_value) :
        feature(feature), name(name), default_value(default_value)
    {
    }
...
{
    constexpr FeatureParam(const Feature* feature, const char* name, int default_value) :
        feature(feature), name(name), default_value(default_value)
    {
    }
...
{
    constexpr FeatureParam(const Feature* feature, const char* name, bool default_value) :
        feature(feature), name(name), default_value(default_value)
    {
    }
