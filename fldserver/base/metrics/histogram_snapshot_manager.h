...
// recorded.
class CORE_EXPORT HistogramSnapshotManager final
{
public:
    ...
    // |Histogram::kNoFlags|.
    void
    PrepareDeltas(const std::vector<HistogramBase*>& histograms,
    ...
    void
    PrepareDelta(HistogramBase* histogram);
    void
    PrepareFinalDelta(const HistogramBase* histogram);
...
private:
    ...
    void
    PrepareSamples(const HistogramBase* histogram, std::unique_ptr<HistogramSamples> samples);
