...
#include "fldserver/base/metrics/histogram_flattener.h"
...
public:
    ...
    MakeActive&
    operator=(const MakeActive&) = delete;
    ~MakeActive()
    {
...
HistogramSnapshotManager::HistogramSnapshotManager(HistogramFlattener* histogram_flattener) :
...
void
HistogramSnapshotManager::PrepareDeltas(const std::vector<HistogramBase*>& histograms,
...
void
HistogramSnapshotManager::PrepareDelta(HistogramBase* histogram)
{
...
void
HistogramSnapshotManager::PrepareFinalDelta(const HistogramBase* histogram)
{
    histogram->ValidateHistogramContents();
...
void
HistogramSnapshotManager::PrepareSamples(const HistogramBase* histogram,
                                         std::unique_ptr<HistogramSamples> samples)
{
    ...
    if (HistogramBase::BUCKET_ORDER_ERROR & corruption)
    {
        ...
        const BucketRanges* ranges = static_cast<const Histogram*>(histogram)->bucket_ranges();
