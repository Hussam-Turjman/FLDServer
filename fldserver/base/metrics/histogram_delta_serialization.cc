...
#include "fldserver/base/metrics/histogram_delta_serialization.h"
...
void
DeserializeHistogramAndAddSamples(PickleIterator* iter)
{
...
HistogramDeltaSerialization::HistogramDeltaSerialization(const std::string& caller_name) :
...
void
HistogramDeltaSerialization::PrepareAndSerializeDeltas(std::vector<std::string>* serialized_deltas,
...
// static
void
HistogramDeltaSerialization::DeserializeAndAddSamples(
        const std::vector<std::string>& serialized_deltas)
{
    for (auto it = serialized_deltas.begin(); it != serialized_deltas.end(); ++it)
    {
...
void
HistogramDeltaSerialization::RecordDelta(const HistogramBase& histogram,
