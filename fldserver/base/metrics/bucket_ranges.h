...
namespace base
{
class CORE_EXPORT BucketRanges
{
public:
    ...
    void
    set_checksum(uint32_t checksum)
    {
        checksum_ = checksum;
    }
    ...
    bool
    Equals(const BucketRanges* other) const;
    ...
    void
    set_persistent_reference(uint32_t ref) const
    {
        persistent_reference_.store(ref, std::memory_order_release);
    }
    uint32_t
    persistent_reference() const
    {
