...
#include "fldserver/base/metrics/crc32.h"

#include <cmath>

namespace base
{
BucketRanges::BucketRanges(size_t num_ranges) : ranges_(num_ranges, 0), checksum_(0)
{
}
...
uint32_t
BucketRanges::CalculateChecksum() const
{
    ...
    return Crc32(static_cast<uint32_t>(ranges_size), &ranges_[0], sizeof(ranges_[0]) * ranges_size);
}
...
bool
BucketRanges::Equals(const BucketRanges* other) const
{
