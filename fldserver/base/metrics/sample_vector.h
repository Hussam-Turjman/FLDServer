...
class CORE_EXPORT SampleVectorBase : public HistogramSamples
{
public:
    SampleVectorBase(uint64_t id, Metadata* meta, const BucketRanges* bucket_ranges);
    SampleVectorBase(const SampleVectorBase&) = delete;
    SampleVectorBase&
    operator=(const SampleVectorBase&) = delete;
    ~SampleVectorBase() override;

    // HistogramSamples:
    void
    Accumulate(HistogramBase::Sample value, HistogramBase::Count count) override;
    HistogramBase::Count
    GetCount(HistogramBase::Sample value) const override;
    HistogramBase::Count
    ...
    HistogramBase::Count
    GetCountAtIndex(size_t bucket_index) const;
...
protected:
    bool
    AddSubtractImpl(SampleCountIterator* iter,
                    HistogramSamples::Operator op) override;  // |op| is ADD or SUBTRACT.

    virtual size_t
    GetBucketIndex(HistogramBase::Sample value) const;
    ...
    virtual bool
    MountExistingCountsStorage() const = 0;
    ...
    CreateCountsStorageWhileLocked() = 0;
    ...
    void
    set_counts(HistogramBase::AtomicCount* counts) const
    {
...
class CORE_EXPORT SampleVector : public SampleVectorBase
{
public:
    ...
    SampleVector&
    operator=(const SampleVector&) = delete;
...
private:
    ...
    // HistogramSamples:
    std::string
    GetAsciiBody() const override;
    std::string
    GetAsciiHeader(StringPiece histogram_name, int32_t flags) const override;

    // SampleVectorBase:
    bool
    MountExistingCountsStorage() const override;
    HistogramBase::Count*
    CreateCountsStorageWhileLocked() override;
...
class CORE_EXPORT PersistentSampleVector : public SampleVectorBase
{
public:
    ...
    PersistentSampleVector&
    operator=(const PersistentSampleVector&) = delete;
...
class CORE_EXPORT SampleVectorIterator : public SampleCountIterator
{
public:
