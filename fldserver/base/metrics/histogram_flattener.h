...
class CORE_EXPORT HistogramFlattener
{
public:
    HistogramFlattener(const HistogramFlattener&) = delete;
    HistogramFlattener&
    operator=(const HistogramFlattener&) = delete;
    virtual ~HistogramFlattener() = default;

    virtual void
    RecordDelta(const HistogramBase& histogram, const HistogramSamples& snapshot) = 0;
