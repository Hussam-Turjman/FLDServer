...
#include "fldserver/base/metrics/histogram_macros_internal.h"
#include "fldserver/base/metrics/histogram_macros_local.h"
...
#define UMA_HISTOGRAM_ENUMERATION(name, ...)                                                       \
    INTERNAL_UMA_HISTOGRAM_ENUMERATION_GET_MACRO(                                                  \
            __VA_ARGS__,                                                                           \
            INTERNAL_UMA_HISTOGRAM_ENUMERATION_SPECIFY_BOUNDARY,                                   \
...
// It'll be necessary to #include "fldserver/base/lazy_instance.h" to use this macro.
...
#define UMA_HISTOGRAM_SCALED_ENUMERATION(name, sample, count, scale)                               \
    INTERNAL_HISTOGRAM_SCALED_ENUMERATION_WITH_FLAG(                                               \
            name, sample, count, scale, base::HistogramBase::kUmaTargetedHistogramFlag)
...
#define UMA_HISTOGRAM_BOOLEAN(name, sample)                                                        \
    STATIC_HISTOGRAM_POINTER_BLOCK(name,                                                           \
                                   AddBoolean(sample),                                             \
...
#define UMA_HISTOGRAM_EXACT_LINEAR(name, sample, exclusive_max)                                    \
    INTERNAL_HISTOGRAM_EXACT_LINEAR_WITH_FLAG(                                                     \
            name, sample, exclusive_max, base::HistogramBase::kUmaTargetedHistogramFlag)
...
//                                     kBucketsMax+1, 1024)
#define UMA_HISTOGRAM_SCALED_EXACT_LINEAR(name, sample, count, sample_max, scale)                  \
...
#define UMA_HISTOGRAM_COUNTS_100(name, sample) UMA_HISTOGRAM_CUSTOM_COUNTS(name, sample, 1, 100, 50)
...
#define UMA_HISTOGRAM_CUSTOM_COUNTS(name, sample, min, max, bucket_count)                          \
    INTERNAL_HISTOGRAM_CUSTOM_COUNTS_WITH_FLAG(                                                    \
            name, sample, min, max, bucket_count, base::HistogramBase::kUmaTargetedHistogramFlag)
...
#define UMA_HISTOGRAM_LONG_TIMES(name, sample)                                                     \
    UMA_HISTOGRAM_CUSTOM_TIMES(                                                                    \
            name, sample, base::TimeDelta::FromMilliseconds(1), base::TimeDelta::FromHours(1), 50)
...
#define UMA_HISTOGRAM_CUSTOM_TIMES(name, sample, min, max, bucket_count)                           \
    STATIC_HISTOGRAM_POINTER_BLOCK(                                                                \
            ...
            base::Histogram::FactoryTimeGet(                                                       \
                    name, min, max, bucket_count, base::HistogramBase::kUmaTargetedHistogramFlag))
...
#define UMA_HISTOGRAM_CUSTOM_MICROSECONDS_TIMES(name, sample, min, max, bucket_count)              \
    STATIC_HISTOGRAM_POINTER_BLOCK(                                                                \
            name,                                                                                  \
            AddTimeMicrosecondsGranularity(sample),                                                \
...
#define UMA_STABILITY_HISTOGRAM_CUSTOM_COUNTS(name, sample, min, max, bucket_count)                \
    INTERNAL_HISTOGRAM_CUSTOM_COUNTS_WITH_FLAG(                                                    \
            name, sample, min, max, bucket_count, base::HistogramBase::kUmaStabilityHistogramFlag)
...
#define UMA_STABILITY_HISTOGRAM_PERCENTAGE(name, percent_as_int)                                   \
    INTERNAL_HISTOGRAM_EXACT_LINEAR_WITH_FLAG(                                                     \
            name, percent_as_int, 101, base::HistogramBase::kUmaStabilityHistogramFlag)
...
#define STATIC_HISTOGRAM_POINTER_GROUP(constant_histogram_name,                                    \
                                       index,                                                      \
                                       constant_maximum,                                           \
    ...
    {                                                                                              \
        ...
        HISTOGRAM_POINTER_USE(std::addressof(atomic_histograms[index]),                            \
...
#define UMA_HISTOGRAM_COUNTS(name, sample) UMA_HISTOGRAM_CUSTOM_COUNTS(name, sample, 1, 1000000, 50)

// MB-granularity memory metric. This has a short max (1G).
#define UMA_HISTOGRAM_MEMORY_MB(name, sample) UMA_HISTOGRAM_CUSTOM_COUNTS(name, sample, 1, 1000, 50)
