...
CORE_EXPORT std::tuple<int, int, int, int>
...
public:
    ...
    int
    extended_model() const
    {
        return ext_model_;
    }
    int
    extended_family() const
    {
        return ext_family_;
    }
    bool
    ...
    bool
    has_non_stop_time_stamp_counter() const
    {
        return has_non_stop_time_stamp_counter_;
    }
    bool
    is_running_in_vm() const
    {
        return is_running_in_vm_;
    }
    ...
    static const std::vector<CoreType>&
    GetGuessedCoreTypes();
    ...
    static bool
    GetCumulativeCoreIdleTimes(CoreIdleTimes&);
...
private:
    ...
    void
    Initialize(bool requires_branding);
