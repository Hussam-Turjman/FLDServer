...
public:
    ...
    SyncSocket&
    operator=(const SyncSocket&) = delete;
    virtual ~SyncSocket();
    ...
    static bool
    CreatePair(SyncSocket* socket_a, SyncSocket* socket_b);
    ...
    virtual size_t
    ReceiveWithTimeout(void* buffer, size_t length, TimeDelta timeout);
...
class CORE_EXPORT CancelableSyncSocket : public SyncSocket
{
public:
    ...
    CancelableSyncSocket&
    operator=(const CancelableSyncSocket&) = delete;
    ...
    static bool
    CreatePair(CancelableSyncSocket* socket_a, CancelableSyncSocket* socket_b);
    ...
    Close() override;
    size_t
    Receive(void* buffer, size_t length) override;
    size_t
    ReceiveWithTimeout(void* buffer, size_t length, TimeDelta timeout) override;
    HANDLE
    file_operation_event_handle() const;
    HANDLE
    shutdown_event_handle() const;
#endif
    ...
    size_t
    Send(const void* buffer, size_t length) override;
