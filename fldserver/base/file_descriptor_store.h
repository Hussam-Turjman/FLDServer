...
class CORE_EXPORT FileDescriptorStore
{
public:
    FileDescriptorStore(const FileDescriptorStore&) = delete;
    FileDescriptorStore&
    operator=(const FileDescriptorStore&) = delete;
    struct Descriptor
    {
        ...
        Descriptor&
        operator=(Descriptor&& other) = default;
