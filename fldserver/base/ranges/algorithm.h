...
#include "fldserver/base/functional/identity.h"
#include "fldserver/base/functional/invoke.h"
#include "fldserver/base/ranges/functional.h"
#include "fldserver/base/ranges/ranges.h"
#include "fldserver/base/template_util.h"
...
constexpr auto
ProjectedUnaryPredicate(Pred& pred, Proj& proj) noexcept
{
    return [&pred, &proj](auto&& arg) -> bool {
        return base::invoke(pred, base::invoke(proj, std::forward<decltype(arg)>(arg)));
    };
}
...
private:
    ...
    using InvokeResult =
            invoke_result_t<Pred&, invoke_result_t<ProjT&, T&&>, invoke_result_t<ProjU&, U&&>>;
...
public:
    ...
    operator()(T&& lhs, U&& rhs) const
    {
        ...
        return base::invoke(pred_,
                            base::invoke(projs.first, std::forward<T>(lhs)),
...
constexpr auto
ProjectedBinaryPredicate(Pred& pred, Proj1& proj1, Proj2& proj2) noexcept
{
...
template <typename Pred, typename Proj1, typename Proj2>
constexpr auto
PermutedProjectedBinaryPredicate(Pred& pred, Proj1& proj1, Proj2& proj2) noexcept
{
...
struct in_fun_result
{
    ...
    template <typename I2,
              typename F2,
              std::enable_if_t<std::is_convertible<I, I2>{} && std::is_convertible<F, F2>{}>>
...
constexpr bool
all_of(InputIterator first, InputIterator last, Pred pred, Proj proj = {})
{
...
constexpr bool
all_of(Range&& range, Pred pred, Proj proj = {})
{
    return ranges::all_of(
            ranges::begin(range), ranges::end(range), std::move(pred), std::move(proj));
}
...
template <typename InputIterator,
          ...
          typename = internal::iterator_category_t<InputIterator>>
constexpr bool
any_of(InputIterator first, InputIterator last, Pred pred, Proj proj = {})
{
    for (; first != last; ++first)
    {
        if (base::invoke(pred, base::invoke(proj, *first)))
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr bool
any_of(Range&& range, Pred pred, Proj proj = {})
{
...
template <typename InputIterator,
          ...
          typename = internal::iterator_category_t<InputIterator>>
constexpr bool
none_of(InputIterator first, InputIterator last, Pred pred, Proj proj = {})
{
    for (; first != last; ++first)
    {
        if (base::invoke(pred, base::invoke(proj, *first)))
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr bool
none_of(Range&& range, Pred pred, Proj proj = {})
{
...
template <typename InputIterator,
          ...
          typename = internal::iterator_category_t<InputIterator>>
constexpr auto
for_each(InputIterator first, InputIterator last, Fun f, Proj proj = {})
{
    for (; first != last; ++first)
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
for_each(Range&& range, Fun f, Proj proj = {})
{
    return ranges::for_each(
            ranges::begin(range), ranges::end(range), std::move(f), std::move(proj));
}
...
template <typename InputIterator,
          ...
          typename = internal::iterator_category_t<InputIterator>>
constexpr auto
for_each_n(InputIterator first, Size n, Fun f, Proj proj = {})
{
    while (n > 0)
    {
        base::invoke(f, base::invoke(proj, *first));
...
template <typename InputIterator,
          ...
          typename = internal::iterator_category_t<InputIterator>>
constexpr auto
find(InputIterator first, InputIterator last, const T& value, Proj proj = {})
{
    for (; first != last; ++first)
    {
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
find(Range&& range, const T& value, Proj proj = {})
{
    return ranges::find(ranges::begin(range), ranges::end(range), value, std::move(proj));
}
...
template <typename InputIterator,
          ...
          typename = internal::iterator_category_t<InputIterator>>
constexpr auto
find_if(InputIterator first, InputIterator last, Pred pred, Proj proj = {})
{
    return std::find_if(first, last, internal::ProjectedUnaryPredicate(pred, proj));
}
...
template <typename InputIterator,
          ...
          typename = internal::iterator_category_t<InputIterator>>
constexpr auto
find_if_not(InputIterator first, InputIterator last, Pred pred, Proj proj = {})
{
    return std::find_if_not(first, last, internal::ProjectedUnaryPredicate(pred, proj));
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
find_if_not(Range&& range, Pred pred, Proj proj = {})
{
...
{
    return std::find_end(
            first1, last1, first2, last2, internal::ProjectedBinaryPredicate(pred, proj1, proj2));
}
...
template <typename Range1,
          ...
          typename = indirect_result_t<Pred&,
                                       ...
                                       projected<iterator_t<Range2>, Proj2>>>
constexpr auto
find_end(Range1&& range1, Range2&& range2, Pred pred = {}, Proj1 proj1 = {}, Proj2 proj2 = {})
{
    return ranges::find_end(ranges::begin(range1),
                            ranges::end(range1),
                            ranges::begin(range2),
                            ranges::end(range2),
                            std::move(pred),
...
template <typename Range1,
          ...
          typename = indirect_result_t<Pred&,
                                       ...
                                       projected<iterator_t<Range2>, Proj2>>>
constexpr auto
find_first_of(Range1&& range1, Range2&& range2, Pred pred = {}, Proj1 proj1 = {}, Proj2 proj2 = {})
{
    return ranges::find_first_of(ranges::begin(range1),
                                 ranges::end(range1),
                                 ranges::begin(range2),
                                 ranges::end(range2),
                                 std::move(pred),
...
constexpr auto
adjacent_find(ForwardIterator first, ForwardIterator last, Pred pred = {}, Proj proj = {})
{
    ...
    {
        if (base::invoke(pred, base::invoke(proj, *first), base::invoke(proj, *next)))
        {
            return first;
        }
    }
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
adjacent_find(Range&& range, Pred pred = {}, Proj proj = {})
{
...
template <typename InputIterator,
          ...
          typename = internal::iterator_category_t<InputIterator>>
constexpr auto
count(InputIterator first, InputIterator last, const T& value, Proj proj = {})
{
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
count(Range&& range, const T& value, Proj proj = {})
{
    return ranges::count(ranges::begin(range), ranges::end(range), value, std::move(proj));
}
...
template <typename InputIterator,
          ...
          typename = internal::iterator_category_t<InputIterator>>
constexpr auto
count_if(InputIterator first, InputIterator last, Pred pred, Proj proj = {})
{
    return std::count_if(first, last, internal::ProjectedUnaryPredicate(pred, proj));
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
count_if(Range&& range, Pred pred, Proj proj = {})
{
...
template <typename ForwardIterator1,
          ...
          typename = indirect_result_t<Pred&,
                                       ...
                                       projected<ForwardIterator2, Proj2>>>
constexpr auto
mismatch(ForwardIterator1 first1,
         ForwardIterator1 last1,
         ForwardIterator2 first2,
         ForwardIterator2 last2,
         Pred pred = {},
...
template <typename Range1,
          ...
          typename = indirect_result_t<Pred&,
                                       ...
                                       projected<iterator_t<Range2>, Proj2>>>
constexpr auto
mismatch(Range1&& range1, Range2&& range2, Pred pred = {}, Proj1 proj1 = {}, Proj2 proj2 = {})
{
    return ranges::mismatch(ranges::begin(range1),
                            ranges::end(range1),
                            ranges::begin(range2),
                            ranges::end(range2),
                            std::move(pred),
      ...
      Proj2 proj2 = {})
{
    if (base::is_constant_evaluated())
    {
        ...
        {
            if (!base::invoke(pred, base::invoke(proj1, *first1), base::invoke(proj2, *first2)))
            {
                return false;
            }
        }
...
template <typename Range1,
          ...
          typename = indirect_result_t<Pred&,
                                       ...
                                       projected<iterator_t<Range2>, Proj2>>>
constexpr bool
equal(Range1&& range1, Range2&& range2, Pred pred = {}, Proj1 proj1 = {}, Proj2 proj2 = {})
{
    return ranges::equal(ranges::begin(range1),
                         ranges::end(range1),
                         ranges::begin(range2),
                         ranges::end(range2),
                         std::move(pred),
...
template <typename ForwardIterator1,
          ...
          typename = indirect_result_t<Pred&,
                                       ...
                                       projected<ForwardIterator2, Proj2>>>
constexpr bool
is_permutation(ForwardIterator1 first1,
               ForwardIterator1 last1,
               ForwardIterator2 first2,
               ForwardIterator2 last2,
               Pred pred = {},
               ...
               Proj2 proj2 = {})
{
    ...
    return std::is_permutation(first1,
                               last1,
                               first2,
                               last2,
...
template <typename Range1,
          ...
          typename = indirect_result_t<Pred&,
                                       ...
                                       projected<iterator_t<Range2>, Proj2>>>
constexpr bool
is_permutation(Range1&& range1, Range2&& range2, Pred pred = {}, Proj1 proj1 = {}, Proj2 proj2 = {})
{
    return ranges::is_permutation(ranges::begin(range1),
                                  ranges::end(range1),
                                  ranges::begin(range2),
                                  ranges::end(range2),
                                  std::move(pred),
...
template <typename Range1,
          ...
          typename = indirect_result_t<Pred&,
                                       ...
                                       projected<iterator_t<Range2>, Proj2>>>
constexpr auto
search(Range1&& range1, Range2&& range2, Pred pred = {}, Proj1 proj1 = {}, Proj2 proj2 = {})
{
    return ranges::search(ranges::begin(range1),
                          ranges::end(range1),
                          ranges::begin(range2),
                          ranges::end(range2),
                          std::move(pred),
         ...
         Proj proj = {})
{
    ...
    identity value_proj;
    return std::search_n(
            first, last, count, value, internal::ProjectedBinaryPredicate(pred, proj, value_proj));
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
search_n(Range&& range, Size count, const T& value, Pred pred = {}, Proj proj = {})
{
    return ranges::search_n(ranges::begin(range),
                            ranges::end(range),
                            count,
                            value,
                            std::move(pred),
...
template <typename Range,
          ...
          typename = internal::iterator_category_t<OutputIterator>>
constexpr auto
copy(Range&& range, OutputIterator result)
{
...
template <typename InputIterator,
          ...
          typename = internal::iterator_category_t<OutputIterator>>
constexpr auto
copy_if(InputIterator first, InputIterator last, OutputIterator result, Pred pred, Proj proj = {})
{
    return std::copy_if(first, last, result, internal::ProjectedUnaryPredicate(pred, proj));
}
...
template <typename Range,
          ...
          typename = internal::iterator_category_t<OutputIterator>>
constexpr auto
copy_if(Range&& range, OutputIterator result, Pred pred, Proj proj = {})
{
    return ranges::copy_if(
            ranges::begin(range), ranges::end(range), result, std::move(pred), std::move(proj));
}
...
constexpr auto
copy_backward(Range&& range, BidirectionalIterator result)
{
    return ranges::copy_backward(ranges::begin(range), ranges::end(range), result);
}
...
template <typename Range,
          ...
          typename = internal::iterator_category_t<OutputIterator>>
constexpr auto
move(Range&& range, OutputIterator result)
{
...
template <typename Range,
          ...
          typename = internal::iterator_category_t<BidirectionalIterator>>
constexpr auto
move_backward(Range&& range, BidirectionalIterator result)
{
    return ranges::move_backward(ranges::begin(range), ranges::end(range), result);
}
            ...
            ForwardIterator2 last2)
{
    ...
    last1 = std::next(first1, std::min(std::distance(first1, last1), std::distance(first2, last2)));
...
swap_ranges(Range1&& range1, Range2&& range2)
{
    return ranges::swap_ranges(
            ranges::begin(range1), ranges::end(range1), ranges::begin(range2), ranges::end(range2));
}
...
template <typename InputIterator,
          ...
          typename = internal::iterator_category_t<InputIterator>,
          typename = internal::iterator_category_t<OutputIterator>,
          typename = indirect_result_t<UnaryOperation&, projected<InputIterator, Proj>>>
constexpr auto
          ...
          Proj proj = {})
{
    return std::transform(first1, last1, result, [&op, &proj](auto&& arg) {
        return base::invoke(op, base::invoke(proj, std::forward<decltype(arg)>(arg)));
    });
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>,
          typename = internal::iterator_category_t<OutputIterator>,
          typename = indirect_result_t<UnaryOperation&, projected<iterator_t<Range>, Proj>>>
constexpr auto
transform(Range&& range, OutputIterator result, UnaryOperation op, Proj proj = {})
{
    return ranges::transform(
            ranges::begin(range), ranges::end(range), result, std::move(op), std::move(proj));
}
...
template <typename ForwardIterator1,
          ...
          typename = indirect_result_t<BinaryOperation&,
                                       ...
                                       projected<ForwardIterator2, Proj2>>>
constexpr auto
transform(ForwardIterator1 first1,
          ForwardIterator1 last1,
          ForwardIterator2 first2,
          ForwardIterator2 last2,
          OutputIterator result,
          ...
          Proj2 proj2 = {})
{
    ...
    return std::transform(
            first1, last1, first2, result, [&binary_op, &proj1, &proj2](auto&& lhs, auto&& rhs) {
                return base::invoke(binary_op,
                                    base::invoke(proj1, std::forward<decltype(lhs)>(lhs)),
...
transform(Range1&& range1,
          ...
          Proj2 proj2 = {})
{
    return ranges::transform(ranges::begin(range1),
                             ranges::end(range1),
                             ranges::begin(range2),
                             ranges::end(range2),
                             result,
        ...
        Proj proj = {})
{
    ...
    std::replace_if(
            ...
            [&proj, &old_value](auto&& lhs) {
                return base::invoke(proj, std::forward<decltype(lhs)>(lhs)) == old_value;
            },
            new_value);
    return last;
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
replace(Range&& range, const T& old_value, const T& new_value, Proj proj = {})
{
    return ranges::replace(
            ranges::begin(range), ranges::end(range), old_value, new_value, std::move(proj));
}
...
replace_if(ForwardIterator first,
           ...
           Proj proj = {})
{
    std::replace_if(first, last, internal::ProjectedUnaryPredicate(pred, proj), new_value);
    return last;
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
replace_if(Range&& range, Predicate pred, const T& new_value, Proj proj = {})
{
    return ranges::replace_if(
            ranges::begin(range), ranges::end(range), std::move(pred), new_value, std::move(proj));
}
...
template <typename Range,
          ...
          typename = internal::iterator_category_t<OutputIterator>>
constexpr auto
replace_copy(Range&& range,
             OutputIterator result,
             const T& old_value,
             const T& new_value,
             Proj proj = {})
{
    return ranges::replace_copy(ranges::begin(range),
                                ranges::end(range),
                                result,
                                old_value,
                                new_value,
                ...
                Proj proj = {})
{
    return std::replace_copy_if(
            first, last, result, internal::ProjectedUnaryPredicate(pred, proj), new_value);
}
...
constexpr auto
replace_copy_if(
        Range&& range, OutputIterator result, Predicate pred, const T& new_value, Proj proj = {})
{
    return ranges::replace_copy_if(
            ranges::begin(range), ranges::end(range), result, pred, new_value, std::move(proj));
}
...
template <typename Range, typename T, typename = internal::range_category_t<Range>>
constexpr auto
fill(Range&& range, const T& value)
{
...
template <typename OutputIterator,
          ...
          typename = internal::iterator_category_t<OutputIterator>>
constexpr auto
generate(OutputIterator first, OutputIterator last, Generator gen)
{
...
template <typename Range, typename Generator, typename = internal::range_category_t<Range>>
constexpr auto
generate(Range&& range, Generator gen)
{
    return ranges::generate(ranges::begin(range), ranges::end(range), std::move(gen));
}
...
template <typename ForwardIterator,
          ...
          typename = internal::iterator_category_t<ForwardIterator>>
constexpr auto
remove(ForwardIterator first, ForwardIterator last, const T& value, Proj proj = {})
{
    // Note: In order to be able to apply `proj` to each element in [first, last)
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
remove(Range&& range, const T& value, Proj proj = {})
{
    return ranges::remove(ranges::begin(range), ranges::end(range), value, std::move(proj));
}
...
template <typename ForwardIterator,
          ...
          typename = internal::iterator_category_t<ForwardIterator>>
constexpr auto
remove_if(ForwardIterator first, ForwardIterator last, Predicate pred, Proj proj = {})
{
    return std::remove_if(first, last, internal::ProjectedUnaryPredicate(pred, proj));
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
remove_if(Range&& range, Predicate pred, Proj proj = {})
{
...
template <typename Range,
          ...
          typename = internal::iterator_category_t<OutputIterator>>
constexpr auto
remove_copy(Range&& range, OutputIterator result, const T& value, Proj proj = {})
{
    return ranges::remove_copy(
            ranges::begin(range), ranges::end(range), result, value, std::move(proj));
}
...
constexpr auto
remove_copy_if(
        InputIterator first, InputIterator last, OutputIterator result, Pred pred, Proj proj = {})
{
    return std::remove_copy_if(first, last, result, internal::ProjectedUnaryPredicate(pred, proj));
}
...
template <typename Range,
          ...
          typename = internal::iterator_category_t<OutputIterator>>
constexpr auto
remove_copy_if(Range&& range, OutputIterator result, Pred pred, Proj proj = {})
{
    return ranges::remove_copy_if(
            ranges::begin(range), ranges::end(range), result, std::move(pred), std::move(proj));
}
...
template <typename ForwardIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<ForwardIterator, Proj>>>
constexpr auto
unique(ForwardIterator first, ForwardIterator last, Comp comp = {}, Proj proj = {})
{
    return std::unique(first, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
unique(Range&& range, Comp comp = {}, Proj proj = {})
{
    return ranges::unique(
            ranges::begin(range), ranges::end(range), std::move(comp), std::move(proj));
}
...
template <typename ForwardIterator,
          ...
          typename = internal::iterator_category_t<OutputIterator>>
constexpr auto
unique_copy(ForwardIterator first,
            ForwardIterator last,
            OutputIterator result,
            Comp comp = {},
            Proj proj = {})
{
    return std::unique_copy(
            first, last, result, internal::ProjectedBinaryPredicate(comp, proj, proj));
}
...
template <typename Range,
          ...
          typename = internal::iterator_category_t<OutputIterator>>
constexpr auto
unique_copy(Range&& range, OutputIterator result, Comp comp = {}, Proj proj = {})
{
    return ranges::unique_copy(
            ranges::begin(range), ranges::end(range), result, std::move(comp), std::move(proj));
}
...
template <typename Range,
          ...
          typename = internal::iterator_category_t<OutputIterator>>
constexpr auto
reverse_copy(Range&& range, OutputIterator result)
{
...
template <typename ForwardIterator, typename = internal::iterator_category_t<ForwardIterator>>
constexpr auto
...
template <typename Range,
          ...
          typename = internal::iterator_category_t<OutputIterator>>
constexpr auto
rotate_copy(Range&& range, iterator_t<Range> middle, OutputIterator result)
{
    return ranges::rotate_copy(ranges::begin(range), middle, ranges::end(range), result);
}
...
constexpr auto
shuffle(RandomAccessIterator first, RandomAccessIterator last, UniformRandomBitGenerator&& g)
{
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
shuffle(Range&& range, UniformRandomBitGenerator&& g)
{
    return ranges::shuffle(
            ranges::begin(range), ranges::end(range), std::forward<UniformRandomBitGenerator>(g));
}
...
template <typename RandomAccessIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<RandomAccessIterator, Proj>>>
constexpr auto
sort(RandomAccessIterator first, RandomAccessIterator last, Comp comp = {}, Proj proj = {})
{
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
sort(Range&& range, Comp comp = {}, Proj proj = {})
{
    return ranges::sort(ranges::begin(range), ranges::end(range), std::move(comp), std::move(proj));
}
...
template <typename RandomAccessIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<RandomAccessIterator, Proj>>>
constexpr auto
stable_sort(RandomAccessIterator first, RandomAccessIterator last, Comp comp = {}, Proj proj = {})
{
    std::stable_sort(first, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
    return last;
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
stable_sort(Range&& range, Comp comp = {}, Proj proj = {})
{
...
partial_sort(RandomAccessIterator first,
             ...
             Proj proj = {})
{
    std::partial_sort(first, middle, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
    return last;
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
partial_sort(Range&& range, iterator_t<Range> middle, Comp comp = {}, Proj proj = {})
{
    return ranges::partial_sort(
            ranges::begin(range), middle, ranges::end(range), std::move(comp), std::move(proj));
}
                  ...
                  Proj2 proj2 = {})
{
    ...
    return std::partial_sort_copy(first,
                                  last,
                                  result_first,
                                  result_last,
...
constexpr auto
partial_sort_copy(
        Range1&& range, Range2&& result_range, Comp comp = {}, Proj1 proj1 = {}, Proj2 proj2 = {})
{
    return ranges::partial_sort_copy(ranges::begin(range),
                                     ranges::end(range),
                                     ranges::begin(result_range),
                                     ranges::end(result_range),
                                     std::move(comp),
                                     std::move(proj1),
                                     std::move(proj2));
}
...
template <typename ForwardIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<ForwardIterator, Proj>>>
constexpr auto
is_sorted_until(ForwardIterator first, ForwardIterator last, Comp comp = {}, Proj proj = {})
{
    // Implementation inspired by cppreference.com:
    ...
    for (ForwardIterator next = first; ++next != last; ++first)
    {
        if (base::invoke(comp, base::invoke(proj, *next), base::invoke(proj, *first)))
        {
            return next;
        }
    }
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
is_sorted_until(Range&& range, Comp comp = {}, Proj proj = {})
{
...
template <typename ForwardIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<ForwardIterator, Proj>>>
constexpr auto
is_sorted(ForwardIterator first, ForwardIterator last, Comp comp = {}, Proj proj = {})
{
    return ranges::is_sorted_until(first, last, std::move(comp), std::move(proj)) == last;
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
is_sorted(Range&& range, Comp comp = {}, Proj proj = {})
{
...
nth_element(RandomAccessIterator first,
            ...
            Proj proj = {})
{
    std::nth_element(first, nth, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
    return last;
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
nth_element(Range&& range, iterator_t<Range> nth, Comp comp = {}, Proj proj = {})
{
    return ranges::nth_element(
            ranges::begin(range), nth, ranges::end(range), std::move(comp), std::move(proj));
}
...
constexpr auto
lower_bound(
        ForwardIterator first, ForwardIterator last, const T& value, Comp comp = {}, Proj proj = {})
{
    // The second arg is guaranteed to be `value`, so we'll simply apply the
    // identity projection.
    identity value_proj;
    return std::lower_bound(
            first, last, value, internal::ProjectedBinaryPredicate(comp, proj, value_proj));
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
lower_bound(Range&& range, const T& value, Comp comp = {}, Proj proj = {})
{
    return ranges::lower_bound(
            ranges::begin(range), ranges::end(range), value, std::move(comp), std::move(proj));
}
        ...
        ForwardIterator first, ForwardIterator last, const T& value, Comp comp = {}, Proj proj = {})
{
    ...
    return std::upper_bound(
            first, last, value, internal::ProjectedBinaryPredicate(comp, value_proj, proj));
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
upper_bound(Range&& range, const T& value, Comp comp = {}, Proj proj = {})
{
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
equal_range(Range&& range, const T& value, Comp comp = {}, Proj proj = {})
{
        ...
        ForwardIterator first, ForwardIterator last, const T& value, Comp comp = {}, Proj proj = {})
{
    ...
    return first != last && !base::invoke(comp, value, base::invoke(proj, *first));
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
binary_search(Range&& range, const T& value, Comp comp = {}, Proj proj = {})
{
...
template <typename ForwardIterator,
          ...
          typename = internal::iterator_category_t<ForwardIterator>>
constexpr auto
is_partitioned(ForwardIterator first, ForwardIterator last, Pred pred, Proj proj = {})
{
    return std::is_partitioned(first, last, internal::ProjectedUnaryPredicate(pred, proj));
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
is_partitioned(Range&& range, Pred pred, Proj proj = {})
{
    return ranges::is_partitioned(
            ranges::begin(range), ranges::end(range), std::move(pred), std::move(proj));
}
...
template <typename ForwardIterator,
          ...
          typename = internal::iterator_category_t<ForwardIterator>>
constexpr auto
partition(ForwardIterator first, ForwardIterator last, Pred pred, Proj proj = {})
{
    return std::partition(first, last, internal::ProjectedUnaryPredicate(pred, proj));
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
partition(Range&& range, Pred pred, Proj proj = {})
{
    return ranges::partition(
            ranges::begin(range), ranges::end(range), std::move(pred), std::move(proj));
}
...
template <typename BidirectionalIterator,
          ...
          typename = internal::iterator_category_t<BidirectionalIterator>>
constexpr auto
stable_partition(BidirectionalIterator first, BidirectionalIterator last, Pred pred, Proj proj = {})
{
    return std::stable_partition(first, last, internal::ProjectedUnaryPredicate(pred, proj));
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
stable_partition(Range&& range, Pred pred, Proj proj = {})
{
    return ranges::stable_partition(
            ranges::begin(range), ranges::end(range), std::move(pred), std::move(proj));
}
               ...
               Proj proj = {})
{
    return std::partition_copy(
            first, last, out_true, out_false, internal::ProjectedUnaryPredicate(pred, proj));
}
...
template <typename Range,
          ...
          typename = internal::iterator_category_t<OutputIterator2>>
constexpr auto
partition_copy(Range&& range,
               OutputIterator1 out_true,
               OutputIterator2 out_false,
               Pred pred,
               Proj proj = {})
{
    return ranges::partition_copy(ranges::begin(range),
                                  ranges::end(range),
                                  out_true,
                                  out_false,
                                  std::move(pred),
...
template <typename ForwardIterator,
          ...
          typename = internal::iterator_category_t<ForwardIterator>>
constexpr auto
partition_point(ForwardIterator first, ForwardIterator last, Pred pred, Proj proj = {})
{
    return std::partition_point(first, last, internal::ProjectedUnaryPredicate(pred, proj));
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
partition_point(Range&& range, Pred pred, Proj proj = {})
{
...
merge(Range1&& range1,
      ...
      Proj2 proj2 = {})
{
    return ranges::merge(ranges::begin(range1),
                         ranges::end(range1),
                         ranges::begin(range2),
                         ranges::end(range2),
                         result,
...
inplace_merge(BidirectionalIterator first,
              ...
              Proj proj = {})
{
    std::inplace_merge(first, middle, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
    return last;
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
inplace_merge(Range&& range, iterator_t<Range> middle, Comp comp = {}, Proj proj = {})
{
    return ranges::inplace_merge(
            ranges::begin(range), middle, ranges::end(range), std::move(comp), std::move(proj));
}
...
template <typename Range1,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range1>, Proj1>>>
constexpr auto
includes(Range1&& range1, Range2&& range2, Comp comp = {}, Proj1 proj1 = {}, Proj2 proj2 = {})
{
    return ranges::includes(ranges::begin(range1),
                            ranges::end(range1),
                            ranges::begin(range2),
                            ranges::end(range2),
                            std::move(comp),
...
set_union(Range1&& range1,
          ...
          Proj2 proj2 = {})
{
    return ranges::set_union(ranges::begin(range1),
                             ranges::end(range1),
                             ranges::begin(range2),
                             ranges::end(range2),
                             result,
                 ...
                 Proj2 proj2 = {})
{
    ...
    // comp(proj1(lhs), proj2(rhs)) and comp(proj2(lhs), proj1(rhs)) to compile.
    return std::set_intersection(first1,
                                 last1,
                                 first2,
                                 last2,
                                 result,
...
template <typename Range1,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range1>, Proj1>>>
constexpr auto
set_intersection(Range1&& range1,
                 Range2&& range2,
                 OutputIterator result,
                 Comp comp = {},
                 Proj1 proj1 = {},
                 Proj2 proj2 = {})
{
    return ranges::set_intersection(ranges::begin(range1),
                                    ranges::end(range1),
                                    ranges::begin(range2),
                                    ranges::end(range2),
                                    result,
               ...
               Proj2 proj2 = {})
{
    ...
    // comp(proj1(lhs), proj2(rhs)) and comp(proj2(lhs), proj1(rhs)) to compile.
    return std::set_difference(first1,
                               last1,
                               first2,
                               last2,
                               result,
...
set_difference(Range1&& range1,
               ...
               Proj2 proj2 = {})
{
    return ranges::set_difference(ranges::begin(range1),
                                  ranges::end(range1),
                                  ranges::begin(range2),
                                  ranges::end(range2),
                                  result,
...
template <typename Range1,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range1>, Proj1>>>
constexpr auto
set_symmetric_difference(Range1&& range1,
                         Range2&& range2,
                         OutputIterator result,
                         Comp comp = {},
                         Proj1 proj1 = {},
                         Proj2 proj2 = {})
{
    return ranges::set_symmetric_difference(ranges::begin(range1),
                                            ranges::end(range1),
                                            ranges::begin(range2),
                                            ranges::end(range2),
                                            result,
...
template <typename RandomAccessIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<RandomAccessIterator, Proj>>>
constexpr auto
push_heap(RandomAccessIterator first, RandomAccessIterator last, Comp comp = {}, Proj proj = {})
{
    std::push_heap(first, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
    return last;
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
push_heap(Range&& range, Comp comp = {}, Proj proj = {})
{
    return ranges::push_heap(
            ranges::begin(range), ranges::end(range), std::move(comp), std::move(proj));
}
...
template <typename RandomAccessIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<RandomAccessIterator, Proj>>>
constexpr auto
pop_heap(RandomAccessIterator first, RandomAccessIterator last, Comp comp = {}, Proj proj = {})
{
    std::pop_heap(first, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
    return last;
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
pop_heap(Range&& range, Comp comp = {}, Proj proj = {})
{
    return ranges::pop_heap(
            ranges::begin(range), ranges::end(range), std::move(comp), std::move(proj));
}
...
template <typename RandomAccessIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<RandomAccessIterator, Proj>>>
constexpr auto
make_heap(RandomAccessIterator first, RandomAccessIterator last, Comp comp = {}, Proj proj = {})
{
    std::make_heap(first, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
    return last;
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
make_heap(Range&& range, Comp comp = {}, Proj proj = {})
{
    return ranges::make_heap(
            ranges::begin(range), ranges::end(range), std::move(comp), std::move(proj));
}
...
template <typename RandomAccessIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<RandomAccessIterator, Proj>>>
constexpr auto
sort_heap(RandomAccessIterator first, RandomAccessIterator last, Comp comp = {}, Proj proj = {})
{
    std::sort_heap(first, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
    return last;
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
sort_heap(Range&& range, Comp comp = {}, Proj proj = {})
{
    return ranges::sort_heap(
            ranges::begin(range), ranges::end(range), std::move(comp), std::move(proj));
}
...
template <typename RandomAccessIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<RandomAccessIterator, Proj>>>
constexpr auto
is_heap(RandomAccessIterator first, RandomAccessIterator last, Comp comp = {}, Proj proj = {})
{
    return std::is_heap(first, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
is_heap(Range&& range, Comp comp = {}, Proj proj = {})
{
    return ranges::is_heap(
            ranges::begin(range), ranges::end(range), std::move(comp), std::move(proj));
}
...
template <typename RandomAccessIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<RandomAccessIterator, Proj>>>
constexpr auto
is_heap_until(RandomAccessIterator first, RandomAccessIterator last, Comp comp = {}, Proj proj = {})
{
    return std::is_heap_until(first, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
is_heap_until(Range&& range, Comp comp = {}, Proj proj = {})
{
    return ranges::is_heap_until(
            ranges::begin(range), ranges::end(range), std::move(comp), std::move(proj));
}
...
{
    return base::invoke(comp, base::invoke(proj, b), base::invoke(proj, a)) ? b : a;
}
...
template <typename T, typename Comp = ranges::less, typename Proj = identity>
constexpr T
min(std::initializer_list<T> ilist, Comp comp = {}, Proj proj = {})
{
    return *std::min_element(
            ilist.begin(), ilist.end(), internal::ProjectedBinaryPredicate(comp, proj, proj));
}
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
min(Range&& range, Comp comp = {}, Proj proj = {})
{
    return *std::min_element(ranges::begin(range),
                             ranges::end(range),
...
{
    return base::invoke(comp, base::invoke(proj, a), base::invoke(proj, b)) ? b : a;
}
...
template <typename T, typename Comp = ranges::less, typename Proj = identity>
constexpr T
max(std::initializer_list<T> ilist, Comp comp = {}, Proj proj = {})
{
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
max(Range&& range, Comp comp = {}, Proj proj = {})
{
    return *std::max_element(ranges::begin(range),
                             ranges::end(range),
                             internal::ProjectedBinaryPredicate(comp, proj, proj));
}
...
{
    return std::minmax(a, b, internal::ProjectedBinaryPredicate(comp, proj, proj));
}
...
template <typename T, typename Comp = ranges::less, typename Proj = identity>
constexpr auto
minmax(std::initializer_list<T> ilist, Comp comp = {}, Proj proj = {})
{
    auto it = std::minmax_element(ranges::begin(ilist),
                                  ranges::end(ilist),
                                  internal::ProjectedBinaryPredicate(comp, proj, proj));
...
template <typename Range,
          ...
          typename = internal::range_category_t<Range>>
constexpr auto
minmax(Range&& range, Comp comp = {}, Proj proj = {})
{
    using T = range_value_t<Range>;
    auto it = std::minmax_element(ranges::begin(range),
                                  ranges::end(range),
                                  internal::ProjectedBinaryPredicate(comp, proj, proj));
    return std::pair<T, T>{*it.first, *it.second};
}
...
template <typename ForwardIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<ForwardIterator, Proj>>>
constexpr auto
min_element(ForwardIterator first, ForwardIterator last, Comp comp = {}, Proj proj = {})
{
    return std::min_element(first, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
min_element(Range&& range, Comp comp = {}, Proj proj = {})
{
...
template <typename ForwardIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<ForwardIterator, Proj>>>
constexpr auto
max_element(ForwardIterator first, ForwardIterator last, Comp comp = {}, Proj proj = {})
{
    return std::max_element(first, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
max_element(Range&& range, Comp comp = {}, Proj proj = {})
{
...
template <typename ForwardIterator,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<ForwardIterator, Proj>>>
constexpr auto
minmax_element(ForwardIterator first, ForwardIterator last, Comp comp = {}, Proj proj = {})
{
    return std::minmax_element(first, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
minmax_element(Range&& range, Comp comp = {}, Proj proj = {})
{
    return ranges::minmax_element(
            ranges::begin(range), ranges::end(range), std::move(comp), std::move(proj));
}
...
template <typename ForwardIterator1,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<ForwardIterator1, Proj1>>>
constexpr bool
lexicographical_compare(ForwardIterator1 first1,
                        ForwardIterator1 last1,
                        ForwardIterator2 first2,
                        ForwardIterator2 last2,
                        Comp comp = {},
...
lexicographical_compare(
        Range1&& range1, Range2&& range2, Comp comp = {}, Proj1 proj1 = {}, Proj2 proj2 = {})
{
    return ranges::lexicographical_compare(ranges::begin(range1),
                                           ranges::end(range1),
                                           ranges::begin(range2),
                                           ranges::end(range2),
                                           std::move(comp),
...
next_permutation(BidirectionalIterator first,
                 ...
                 Proj proj = {})
{
    return std::next_permutation(first, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
next_permutation(Range&& range, Comp comp = {}, Proj proj = {})
{
    return ranges::next_permutation(
            ranges::begin(range), ranges::end(range), std::move(comp), std::move(proj));
}
...
prev_permutation(BidirectionalIterator first,
                 ...
                 Proj proj = {})
{
    return std::prev_permutation(first, last, internal::ProjectedBinaryPredicate(comp, proj, proj));
}
...
template <typename Range,
          ...
          typename = indirect_result_t<Comp&,
                                       ...
                                       projected<iterator_t<Range>, Proj>>>
constexpr auto
prev_permutation(Range&& range, Comp comp = {}, Proj proj = {})
{
    return ranges::prev_permutation(
            ranges::begin(range), ranges::end(range), std::move(comp), std::move(proj));
}
