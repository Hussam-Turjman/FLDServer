...
template <typename T, size_t N>
constexpr T*
begin(std::array<T, N>& array, priority_tag<2> tag)
{
...
template <typename T, size_t N>
constexpr const T*
begin(const std::array<T, N>& array, priority_tag<2>)
{
...
constexpr auto
begin(Range&& range, priority_tag<1>) -> decltype(std::forward<Range>(range).begin())
{
...
template <typename Range>
constexpr auto
begin(Range&& range, priority_tag<0>) -> decltype(begin(std::forward<Range>(range)))
{
...
template <typename T, size_t N>
constexpr T*
end(std::array<T, N>& array, priority_tag<2> tag)
{
...
template <typename T, size_t N>
constexpr const T*
end(const std::array<T, N>& array, priority_tag<2>)
{
...
template <typename Range>
constexpr auto
end(Range&& range, priority_tag<1>) -> decltype(std::forward<Range>(range).end())
{
...
template <typename Range>
constexpr auto
end(Range&& range, priority_tag<0>) -> decltype(end(std::forward<Range>(range)))
{
