...
inline void
DispatchToMethodImpl(const ObjT& obj, Method method, Tuple&& args, std::index_sequence<Ns...>)
{
...
inline void
DispatchToMethod(const ObjT& obj, Method method, Tuple&& args)
{
    constexpr size_t size = std::tuple_size<std::decay_t<Tuple>>::value;
    DispatchToMethodImpl(obj, method, std::forward<Tuple>(args), std::make_index_sequence<size>());
}
...
inline void
DispatchToFunctionImpl(Function function, Tuple&& args, std::index_sequence<Ns...>)
{
...
inline void
DispatchToFunction(Function function, Tuple&& args)
{
    constexpr size_t size = std::tuple_size<std::decay_t<Tuple>>::value;
    DispatchToFunctionImpl(function, std::forward<Tuple>(args), std::make_index_sequence<size>());
}
...
template <typename ObjT,
          ...
          size_t... OutNs>
inline void
DispatchToMethodImpl(const ObjT& obj,
                     Method method,
                     InTuple&& in,
                     OutTuple* out,
