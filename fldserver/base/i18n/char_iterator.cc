...
#include "fldserver/base/i18n/char_iterator.h"
...
UTF16CharIterator::UTF16CharIterator(StringPiece16 str) : UTF16CharIterator(str, 0)
{
}
...
// static
UTF16CharIterator
UTF16CharIterator::LowerBound(StringPiece16 str, size_t array_index)
{
...
// static
UTF16CharIterator
UTF16CharIterator::UpperBound(StringPiece16 str, size_t array_index)
{
    DCHECK_LE(array_index, str.length());
...
int32_t
UTF16CharIterator::NextCodePoint() const
{
    if (next_pos_ >= str_.length())
        return 0;
...
int32_t
UTF16CharIterator::PreviousCodePoint() const
{
    if (array_pos_ == 0)
        return 0;
...
UTF16CharIterator::UTF16CharIterator(StringPiece16 str, size_t initial_pos) :
    str_(str), array_pos_(initial_pos), next_pos_(initial_pos), char_offset_(0), char_(0)
{
