...
GetDisplayStringInLTRDirectionality(const std::u16string& text) WARN_UNUSED_RESULT;
...
// pair.
CORE_EXPORT std::u16string
StripWrappingBidiControlCharacters(const std::u16string& text) WARN_UNUSED_RESULT;
