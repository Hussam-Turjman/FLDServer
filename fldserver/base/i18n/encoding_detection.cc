...
#include "fldserver/base/i18n/encoding_detection.h"
...
{
bool
DetectEncoding(const std::string& text, std::string* encoding)
{
    int consumed_bytes;
    bool is_reliable;
    Encoding enc = CompactEncDet::DetectEncoding(text.c_str(),
                                                 text.length(),
                                                 nullptr,
                                                 nullptr,
                                                 nullptr,
