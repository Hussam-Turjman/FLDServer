...
bool
MessageArg::has_value(int* count) const
{
...
std::u16string
MessageFormatter::FormatWithNumberedArgs(StringPiece16 msg,
                                         ...
                                         const internal::MessageArg& arg6)
{
    ...
    if (U_FAILURE(error))
    {
        LOG(ERROR) << "MessageFormat(" << msg << ") failed with " << u_errorName(error);
...
std::u16string
MessageFormatter::FormatWithNamedArgs(StringPiece16 msg,
                                      StringPiece name0,
                                      const internal::MessageArg& arg0,
                                      StringPiece name1,
                                      const internal::MessageArg& arg1,
