...
namespace i18n
{
class CORE_EXPORT UTF8CharIterator
{
public:
    ...
    UTF8CharIterator&
    operator=(const UTF8CharIterator&) = delete;
    ~UTF8CharIterator();
...
class CORE_EXPORT UTF16CharIterator
{
public:
    ...
    UTF16CharIterator&
    operator=(UTF16CharIterator&& to_move);

    UTF16CharIterator(const UTF16CharIterator&) = delete;
    UTF16CharIterator
    operator=(const UTF16CharIterator&) = delete;
    ...
    static UTF16CharIterator
    LowerBound(StringPiece16 str, size_t array_index);

    // Returns an iterator starting on the unicode character at offset
    // |array_index| into the string, or the next offset if |array_index| is the
    // second half of a surrogate pair.
    static UTF16CharIterator
    UpperBound(StringPiece16 str, size_t array_index);
