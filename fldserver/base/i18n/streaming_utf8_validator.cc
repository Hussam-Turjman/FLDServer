...
#include "fldserver/base/i18n/streaming_utf8_validator.h"

#include "fldserver/base/check_op.h"
#include "fldserver/base/i18n/utf8_validator_tables.h"
...
{
uint8_t
StateTableLookup(uint8_t offset)
{
...
StreamingUtf8Validator::State
StreamingUtf8Validator::AddBytes(const char* data, size_t size)
{
    ...
    return state == 0 ? VALID_ENDPOINT
                      : state == internal::I18N_UTF8_VALIDATOR_INVALID_INDEX ? INVALID
                                                                             : VALID_MIDPOINT;
}

void
StreamingUtf8Validator::Reset()
{
    state_ = 0u;
}

bool
StreamingUtf8Validator::Validate(const std::string& string)
{
