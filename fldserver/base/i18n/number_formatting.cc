...
#include "fldserver/base/i18n/number_formatting.h"

#include "fldserver/base/check.h"
#include "fldserver/base/format_macros.h"
#include "fldserver/base/i18n/message_formatter.h"
...
LazyInstance<NumberFormatWrapper>::DestructorAtExit g_number_format_int = LAZY_INSTANCE_INITIALIZER;
...
std::u16string
FormatDouble(double number, int fractional_digits)
{
...
std::u16string
FormatPercent(int number)
{
    return i18n::MessageFormatter::FormatWithNumberedArgs(u"{0,number,percent}",
