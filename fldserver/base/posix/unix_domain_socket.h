...
class CORE_EXPORT UnixDomainSocket
{
public:
    ...
    static ssize_t
    RecvMsg(int fd, void* msg, size_t length, std::vector<ScopedFD>* fds);
    ...
    // receiving socket.
    static ssize_t
    RecvMsgWithPid(int fd, void* msg, size_t length, std::vector<ScopedFD>* fds, ProcessId* pid);
    ...
    static ssize_t
    SendRecvMsg(int fd, uint8_t* reply, unsigned reply_len, int* result_fd, const Pickle& request);
