...
class CORE_EXPORT GlobalDescriptors
{
public:
    ...
    void
    Set(Key key, int fd, base::MemoryMappedFile::Region region);

    void
    Reset(const Mapping& mapping);
