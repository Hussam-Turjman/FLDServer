...
public:
    static bool
    AdjustOOMScore(ProcessId process, int score);
...
// static.
bool
AdjustOOMScoreHelper::AdjustOOMScore(ProcessId process, int score)
{
...
bool
UncheckedMalloc(size_t size, void** result)
{
#if 0
    *result = allocator::UncheckedAlloc(size);
#elif defined(MEMORY_TOOL_REPLACES_ALLOCATOR) || (!defined(LIBC_GLIBC) && !0)
    *result = malloc(size);
#elif defined(LIBC_GLIBC) && !0
