...
public:
    ...
    UniqueProcId&
    operator=(const UniqueProcId& other) = default;
    ...
    bool
    operator==(const UniqueProcId& other) const
    {
...
std::ostream&
operator<<(std::ostream& os, const UniqueProcId& obj);

// Returns the id of the current process.
// Note that on some platforms, this is not guaranteed to be unique across
// processes (use GetUniqueIdForProcess if uniqueness is required).
CORE_EXPORT ProcessId
GetCurrentProcId();
...
CORE_EXPORT void
InitUniqueIdForProcessInPidNamespace(ProcessId pid_outside_of_namespace);
#endif

// Returns the ProcessHandle of the current process.
CORE_EXPORT ProcessHandle
