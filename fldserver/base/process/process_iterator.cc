...
ProcessIterator::ProcessEntries
...
NamedProcessIterator::NamedProcessIterator(const FilePath::StringType& executable_name,
    ...
    ProcessIterator(filter), executable_name_(executable_name)
{
    ...
    {
        executable_name_ = FilePath::StringType(executable_name_, executable_name_.size() - 15, 15);
    }
#endif
}
