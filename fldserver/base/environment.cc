...
public:
    bool
    GetVar(StringPiece variable_name, std::string* result) override
    {
    ...
    bool
    UnSetVar(StringPiece variable_name) override
    {
...
private:
    bool
    GetVarImpl(StringPiece variable_name, std::string* result)
    {
#if IS_WIN
        DWORD value_length =
        ...
        if (result)
        {
            ...
            ::GetEnvironmentVariable(UTF8ToWide(variable_name).c_str(), value.get(), value_length);
    ...
    bool
    SetVarImpl(StringPiece variable_name, const std::string& new_value)
    {
#if IS_WIN
    ...
    bool
    UnSetVarImpl(StringPiece variable_name)
    {
#if IS_WIN
        // On success, a nonzero value is returned.
...
bool
Environment::HasVar(StringPiece variable_name)
{
