...
CORE_EXPORT extern const char kDotConfigDir[];

// The XDG config directory environment variable.
CORE_EXPORT extern const char kXdgConfigHomeEnvVar[];

// The XDG current desktop environment variable.
CORE_EXPORT extern const char kXdgCurrentDesktopEnvVar[];

// The XDG session type environment variable.
CORE_EXPORT extern const char kXdgSessionTypeEnvVar[];
...
CORE_EXPORT DesktopEnvironment
