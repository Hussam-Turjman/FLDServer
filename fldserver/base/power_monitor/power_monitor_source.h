...
class CORE_EXPORT PowerMonitorSource
{
public:
    PowerMonitorSource();
    ...
    virtual PowerThermalObserver::DeviceThermalState
    ...
    static const char*
    DeviceThermalStateToString(PowerThermalObserver::DeviceThermalState state);
...
protected:
    ...
    static void
    ProcessPowerEvent(PowerEvent event_id);
    static void
    ProcessThermalEvent(PowerThermalObserver::DeviceThermalState new_thermal_state);
