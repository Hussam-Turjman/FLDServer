...
#include "fldserver/base/strings/char_traits.h"
...
{
CORE_EXPORT size_t
find(StringPiece self, StringPiece s, size_t pos);
CORE_EXPORT size_t
find(StringPiece16 self, StringPiece16 s, size_t pos);

CORE_EXPORT size_t
rfind(StringPiece self, StringPiece s, size_t pos);
CORE_EXPORT size_t
rfind(StringPiece16 self, StringPiece16 s, size_t pos);

CORE_EXPORT size_t
find_first_of(StringPiece self, StringPiece s, size_t pos);
CORE_EXPORT size_t
find_first_of(StringPiece16 self, StringPiece16 s, size_t pos);

CORE_EXPORT size_t
find_first_not_of(StringPiece self, StringPiece s, size_t pos);
CORE_EXPORT size_t
find_first_not_of(StringPiece16 self, StringPiece16 s, size_t pos);

CORE_EXPORT size_t
find_last_of(StringPiece self, StringPiece s, size_t pos);
CORE_EXPORT size_t
find_last_of(StringPiece16 self, StringPiece16 s, size_t pos);

CORE_EXPORT size_t
find_last_not_of(StringPiece self, StringPiece s, size_t pos);
CORE_EXPORT size_t
find_last_not_of(StringPiece16 self, StringPiece16 s, size_t pos);

CORE_EXPORT size_t
find(WStringPiece self, WStringPiece s, size_t pos);
CORE_EXPORT size_t
rfind(WStringPiece self, WStringPiece s, size_t pos);
CORE_EXPORT size_t
find_first_of(WStringPiece self, WStringPiece s, size_t pos);
CORE_EXPORT size_t
find_first_not_of(WStringPiece self, WStringPiece s, size_t pos);
CORE_EXPORT size_t
find_last_of(WStringPiece self, WStringPiece s, size_t pos);
CORE_EXPORT size_t
find_last_not_of(WStringPiece self, WStringPiece s, size_t pos);
...
public:
    ...
    constexpr BasicStringPiece&
    operator=(const BasicStringPiece& view) noexcept = default;
    constexpr BasicStringPiece(const CharT* s, size_type count) : ptr_(s), length_(count)
    {
    }
    ...
    // BasicStringPiece.
    BasicStringPiece(const std::basic_string<CharT>& str) : ptr_(str.data()), length_(str.size())
    {
    }
    ...
    constexpr bool
    empty() const noexcept WARN_UNUSED_RESULT
    {
        return size() == 0;
    }
    ...
    constexpr void
    swap(BasicStringPiece& v) noexcept
    {
    ...
    constexpr int
    compare(BasicStringPiece v) const noexcept
    {
    ...
    constexpr int
    compare(size_type pos1, size_type count1, BasicStringPiece v) const
    {
        return substr(pos1, count1).compare(v);
    }
    constexpr int
    compare(size_type pos1, size_type count1, BasicStringPiece v, size_type pos2, size_type count2)
            const
    {
    ...
    constexpr size_type
    find(BasicStringPiece v, size_type pos = 0) const noexcept
    {
    ...
    find(CharT ch, size_type pos = 0) const noexcept
    {
        ...
        const const_pointer result = base::CharTraits<CharT>::find(data() + pos, size() - pos, ch);
    ...
    constexpr size_type
    rfind(BasicStringPiece v, size_type pos = npos) const noexcept
    {
    ...
    constexpr size_type
    find_first_of(BasicStringPiece v, size_type pos = 0) const noexcept
    {
    ...
    constexpr size_type
    find_last_of(BasicStringPiece v, size_type pos = npos) const noexcept
    {
    ...
    constexpr size_type
    find_first_not_of(BasicStringPiece v, size_type pos = 0) const noexcept
    {
    ...
    constexpr size_type
    find_last_not_of(BasicStringPiece v, size_type pos = npos) const noexcept
    {
...
// static
template <typename CharT, typename Traits>
const typename BasicStringPiece<CharT, Traits>::size_type BasicStringPiece<CharT, Traits>::npos;

// MSVC doesn't like complex extern templates and DLLs.
#if !defined(COMPILER_MSVC)
extern template class CORE_EXPORT BasicStringPiece<char>;
extern template class CORE_EXPORT BasicStringPiece<char16_t>;
#endif

template <typename CharT, typename Traits>
constexpr bool
operator==(BasicStringPiece<CharT, Traits> lhs, BasicStringPiece<CharT, Traits> rhs) noexcept
{
...
constexpr bool
operator==(BasicStringPiece<CharT, Traits> lhs,
...
constexpr bool
operator==(std::common_type_t<BasicStringPiece<CharT, Traits>> lhs,
...
// 8-bit-width stream.
CORE_EXPORT std::ostream&
operator<<(std::ostream& o, StringPiece16 piece);
CORE_EXPORT std::ostream&
operator<<(std::ostream& o, WStringPiece piece);
...
struct StringPieceHashImpl
{
    ...
    std::size_t
    operator()(StringPieceType sp) const
    {
        std::size_t result = 0;
        for (auto c : sp)
            result = (result * 131) + c;
