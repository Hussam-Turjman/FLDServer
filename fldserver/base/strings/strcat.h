...
StrCat(span<const StringPiece> pieces) WARN_UNUSED_RESULT;
CORE_EXPORT std::u16string
StrCat(span<const StringPiece16> pieces) WARN_UNUSED_RESULT;
CORE_EXPORT std::string
StrCat(span<const std::string> pieces) WARN_UNUSED_RESULT;
CORE_EXPORT std::u16string
StrCat(span<const std::u16string> pieces) WARN_UNUSED_RESULT;

// Initializer list forwards to the array version.
inline std::string
StrCat(std::initializer_list<StringPiece> pieces)
{
    return StrCat(make_span(pieces));
}

inline std::u16string
StrCat(std::initializer_list<StringPiece16> pieces)
{
    return StrCat(make_span(pieces));
}
...
CORE_EXPORT void
StrAppend(std::string* dest, span<const StringPiece> pieces);
CORE_EXPORT void
StrAppend(std::u16string* dest, span<const StringPiece16> pieces);
CORE_EXPORT void
StrAppend(std::string* dest, span<const std::string> pieces);
CORE_EXPORT void
StrAppend(std::u16string* dest, span<const std::u16string> pieces);

// Initializer list forwards to the array version.
inline void
StrAppend(std::string* dest, std::initializer_list<StringPiece> pieces)
{
    StrAppend(dest, make_span(pieces));
}

inline void
StrAppend(std::u16string* dest, std::initializer_list<StringPiece16> pieces)
{
    StrAppend(dest, make_span(pieces));
}
