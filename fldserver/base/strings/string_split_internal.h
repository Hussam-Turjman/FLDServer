...
WhitespaceForType<char16_t>()
{
    return kWhitespaceUTF16;
}
template <>
inline StringPiece
WhitespaceForType<char>()
{
...
static std::vector<OutputStringType>
SplitStringT(BasicStringPiece<CharT> str,
...
template <typename OutputStringType, typename CharT>
std::vector<OutputStringType>
SplitStringUsingSubstrT(BasicStringPiece<CharT> input,
                        BasicStringPiece<CharT> delimiter,
                        WhitespaceHandling whitespace,
                        SplitResult result_type)
{
