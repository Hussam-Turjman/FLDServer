...
auto
Resize(std::basic_string<CharT>& str, size_t total_size, priority_tag<1>)
...
template <typename CharT>
void
Resize(std::basic_string<CharT>& str, size_t total_size, priority_tag<0>)
{
...
void
StrAppendT(std::basic_string<CharT>& dest, span<const StringT> pieces)
{
...
auto
StrCatT(span<const StringT> pieces)
{
