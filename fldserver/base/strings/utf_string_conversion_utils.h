...
{
inline bool
IsValidCodepoint(uint32_t code_point)
{
...
inline bool
IsValidCharacter(uint32_t code_point)
{
...
CORE_EXPORT bool
ReadUnicodeCharacter(const wchar_t* src,
                     int32_t src_len,
                     int32_t* char_index,
                     uint32_t* code_point);
...
inline size_t
WriteUnicodeCharacter(uint32_t code_point, std::wstring* output)
{
