...
JSONReader::ValueWithError&
JSONReader::ValueWithError::operator=(ValueWithError&& other) = default;

// static
Optional<Value>
JSONReader::Read(StringPiece json, int options, size_t max_depth)
{
...
JSONReader::ReadDeprecated(StringPiece json, int options, size_t max_depth)
{
...
// static
JSONReader::ValueWithError
JSONReader::ReadAndReturnValueWithError(StringPiece json, int options)
{
    ValueWithError ret;
