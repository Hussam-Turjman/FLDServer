...
class CORE_EXPORT JSONFileValueSerializer : public base::ValueSerializer
{
public:
...
class CORE_EXPORT JSONFileValueDeserializer : public base::ValueDeserializer
{
public:
    ...
    explicit JSONFileValueDeserializer(const base::FilePath& json_file_path, int options = 0);
...
private:
    ...
    int
    ReadFileToString(std::string* json_string);
