...
#include "fldserver/base/json/json_common.h"
...
private:
    ...
    bool
    ConsumeStringRaw(StringBuilder* out);
    ...
    bool
    DecodeUTF16(uint32_t* out_code_point);
    ...
    bool
    ReadInt(bool allow_leading_zeros);
    ...
    void
    ReportError(JsonParseError code, int column_adjust);
    ...
    static std::string
    FormatErrorMessage(int line, int column, const std::string& description);
...
CORE_EXPORT extern const char kUnicodeReplacementString[];
