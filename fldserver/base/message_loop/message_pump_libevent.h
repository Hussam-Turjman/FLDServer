...
#include "fldserver/base/message_loop/watchable_io_message_pump_posix.h"
...
class CORE_EXPORT MessagePumpLibevent : public MessagePump, public WatchableIOMessagePumpPosix
{
public:
    ...
    public:
        ...
        bool
        StopWatchingFileDescriptor() override;
    ...
    private:
        ...
        void
        set_pump(MessagePumpLibevent* pump)
        {
            pump_ = pump;
        }
        MessagePumpLibevent*
        ...
        void
        set_watcher(FdWatcher* watcher)
        {
            watcher_ = watcher;
        }

        void
        OnFileCanReadWithoutBlocking(int fd, MessagePumpLibevent* pump);
        void
        OnFileCanWriteWithoutBlocking(int fd, MessagePumpLibevent* pump);
...
private:
    ...
    static void
    OnLibeventNotification(int fd, short flags, void* context);

    // Unix pipe used to implement ScheduleWork()
    // ... callback; called by libevent inside Run() when pipe is ready to read
    static void
    OnWakeup(int socket, short flags, void* context);
