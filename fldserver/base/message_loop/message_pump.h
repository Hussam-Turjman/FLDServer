...
public:
    ...
    static void
    OverrideMessagePumpForUIFactory(MessagePumpFactory* factory);
    ...
    static std::unique_ptr<MessagePump>
    Create(MessagePumpType type);
    ...
    public:
        ...
        public:
            ...
            ScopedDoNativeWork&
            operator=(ScopedDoNativeWork&& rhs)
            {
                outer_ = std::exchange(rhs.outer_, nullptr);
                return *this;
            }
        ...
        ScopedDoNativeWork
        BeginNativeWork() WARN_UNUSED_RESULT
        {
    ...
    // entered.
    virtual void
    ScheduleDelayedWork(const TimeTicks& delayed_work_time) = 0;

    // Sets the timer slack to the specified value.
    virtual void
    SetTimerSlack(TimerSlack timer_slack);
};
