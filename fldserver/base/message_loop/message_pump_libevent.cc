...
bool
MessagePumpLibevent::FdWatchController::StopWatchingFileDescriptor()
{
...
void
MessagePumpLibevent::FdWatchController::Init(std::unique_ptr<event> e)
{
    DCHECK(e);
    DCHECK(!event_);
...
MessagePumpLibevent::FdWatchController::ReleaseEvent()
{
    return std::move(event_);
}

void
MessagePumpLibevent::FdWatchController::OnFileCanReadWithoutBlocking(int fd,
...
void
MessagePumpLibevent::FdWatchController::OnFileCanWriteWithoutBlocking(int fd,
                                                                      MessagePumpLibevent* pump)
{
    DCHECK(watcher_);
...
bool
MessagePumpLibevent::WatchFileDescriptor(
        int fd, bool persistent, int mode, FdWatchController* controller, FdWatcher* delegate)
{
    DCHECK_GE(fd, 0);
    DCHECK(controller);
    DCHECK(delegate);
...
static void
timer_callback(int fd, short events, void* context)
{
...
void
MessagePumpLibevent::ScheduleWork()
{
...
void
MessagePumpLibevent::ScheduleDelayedWork(const TimeTicks& delayed_work_time)
{
...
// static
void
MessagePumpLibevent::OnLibeventNotification(int fd, short flags, void* context)
{
...
// static
void
MessagePumpLibevent::OnWakeup(int socket, short flags, void* context)
{
