...
// static
void
MessagePump::OverrideMessagePumpForUIFactory(MessagePumpFactory* factory)
{
...
// static
bool
MessagePump::IsMessagePumpForUIFactoryOveridden()
{
...
MessagePump::Create(MessagePumpType type)
{
    switch (type)
    {
        ...
        case MessagePumpType::JAVA: return std::make_unique<MessagePumpForUI>();
#endif

#if IS_APPLE
        case MessagePumpType::NS_RUNLOOP: return std::make_unique<MessagePumpNSRunLoop>();
#endif
        ...
        case MessagePumpType::CUSTOM: NOTREACHED(); return nullptr;
