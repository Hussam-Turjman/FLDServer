...
public:
    ...
    static void
    AddNestingObserverOnCurrentThread(NestingObserver* observer);
    static void
    RemoveNestingObserverOnCurrentThread(NestingObserver* observer);
    ...
    public:
        ...
        Delegate&
        operator=(const Delegate&) = delete;
        virtual ~Delegate();
        ...
        virtual void
        Run(bool application_tasks_allowed, TimeDelta timeout) = 0;
        virtual void
        Quit() = 0;
    ...
    static void
    RegisterDelegateForCurrentThread(Delegate* delegate);
    ...
    static void
    QuitCurrentDeprecated();
    static void
    QuitCurrentWhenIdleDeprecated();
    static RepeatingClosure
    QuitCurrentWhenIdleClosureDeprecated();
    ...
    class CORE_EXPORT ScopedDisallowRunning
    {
    public:
        ScopedDisallowRunning();
        ScopedDisallowRunning(const ScopedDisallowRunning&) = delete;
        ScopedDisallowRunning&
        operator=(const ScopedDisallowRunning&) = delete;
        ~ScopedDisallowRunning();
    ...
    struct CORE_EXPORT RunLoopTimeout
    {
        RunLoopTimeout();
        ~RunLoopTimeout();
        TimeDelta timeout;
...
private:
    ...
    static void
    SetTimeoutForCurrentThread(const RunLoopTimeout* timeout);
    static const RunLoopTimeout*
    GetTimeoutForCurrentThread();
