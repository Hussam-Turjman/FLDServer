...
#include "fldserver/base/ced/util/languages/languages.pb.h"
...
//
inline bool
IS_LANGUAGE_UNKNOWN(Language lang)
{
...
bool
IsChineseLanguage(Language lang);
...
// (regular or Nynorsk).
bool
IsNorwegianLanguage(Language lang);
...
bool
IsPortugueseLanguage(Language lang);
...
// false.
bool
IsSameLanguage(Language lang1, Language lang2);
...
bool
IsRightToLeftLanguage(Language lang);
...
bool
IsMaybeRightToLeftLanguage(Language lang);
...
const char*
LanguageEnumName(Language lang);
...
//
bool
LanguageFromName(const char* lang_name, Language* language);
...
const char*
LanguageCodeWithDialects(Language lang);
...
const char*
LanguageCodeISO639_1(Language lang);
...
const char*
LanguageCodeISO639_2(Language lang);
...
bool
LanguageFromCode(const char* lang_code, Language* language);
...
//
bool
LanguageFromCodeOrName(const char* lang_code_or_name, Language* language);
...
//
const char*
LanguageNameFromCode(const char* language_code);
...
bool
LanguageCodeToUnderscoreForm(const char* lang_code, char* result, int result_length);
...
bool
AlwaysPutInExpectedRestrict(const char* tld, Language* expected_language);
