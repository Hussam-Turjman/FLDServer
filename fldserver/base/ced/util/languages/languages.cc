...
#include "fldserver/base/ced/util/languages/languages.h"
...
{
    return IsValidLanguage(lang) ? kLanguageInfoTable[lang].language_name_ : kInvalidLanguageName;
}
...
LanguageFromCode(const char* lang_code, Language* language)
{
    *language = UNKNOWN_LANGUAGE;
    ...
    for (int i = 0; i < kNumLanguages; i++)
    {
        ...
        if ((info.language_code_639_1_ && !base::strcasecmp(lang_code, info.language_code_639_1_))
