...
#include "fldserver/base/ced/util/encodings/encodings.h"  // for Encoding
#include "fldserver/base/ced/util/languages/languages.h"  // for Language
...
Encoding
DetectEncoding(const char* text,
               int text_length,
               const char* url_hint,
...
int
BackmapEncodingToRankedEncoding(Encoding enc);
Encoding
TopEncodingOfLangHint(const char* name);
Encoding
TopEncodingOfTLDHint(const char* name);
Encoding
TopEncodingOfCharsetHint(const char* name);
const char*
Version(void);
