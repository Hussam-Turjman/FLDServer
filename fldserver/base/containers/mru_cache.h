...
size_t
DoEstimateMemoryUsageForMruCache(const MruCacheType&);
...
private:
    ...
    typedef typename MapType<KeyType, typename PayloadList::iterator, HashOrCompareType>::Type
            KeyIndex;
...
public:
    ...
    iterator
    Put(const KeyType& key, Payload&& payload)
    {
    ...
    void
    ShrinkToSize(size_type new_size)
    {
...
private:
    template <class MruCacheType>
    friend size_t
    trace_event::internal::DoEstimateMemoryUsageForMruCache(const MruCacheType&);
...
public:
    ...
    MRUCache&
    operator=(const MRUCache&) = delete;
...
public:
    ...
    HashingMRUCache&
    operator=(const HashingMRUCache&) = delete;
