...
struct IsStringIterImpl : disjunction<std::is_same<T, typename StringT::const_iterator>,
...
template <typename T>
struct IsStringIter : conjunction<std::is_trivial<iter_value_t<T>>, IsStringIterImpl<T>>
{
};
...
struct IsArrayIter : disjunction<std::is_same<T, typename ArrayT::const_iterator>,
...
struct IsVectorIter : conjunction<negation<std::is_same<iter_value_t<T>, bool>>,
...
template <typename T>
struct IsContiguousIteratorImpl : conjunction<PointsToObject<T>,
...
template <typename T>
struct IsContiguousIterator : internal::IsContiguousIteratorImpl<remove_cvref_t<T>>
{
};
