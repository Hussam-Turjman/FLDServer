...
{
public:
    typedef /* typename std::allocator<T>::pointer*/ T* pointer;
...
public:
    ...
    StackContainer&
    operator=(const StackContainer&) = delete;
    ...
    const typename Allocator::Source&
    stack_data() const
    {
        return stack_data_;
    }
...
template <typename TContainerType, int stack_capacity>
auto
begin(const StackContainer<TContainerType, stack_capacity>& stack_container)
...
template <typename TContainerType, int stack_capacity>
auto
begin(StackContainer<TContainerType, stack_capacity>& stack_container)
        -> decltype(begin(stack_container.container()))
{
    return begin(stack_container.container());
}
...
template <typename TContainerType, int stack_capacity>
auto
end(StackContainer<TContainerType, stack_capacity>& stack_container)
...
template <typename TContainerType, int stack_capacity>
auto
end(const StackContainer<TContainerType, stack_capacity>& stack_container)
        -> decltype(end(stack_container.container()))
{
    return end(stack_container.container());
}
