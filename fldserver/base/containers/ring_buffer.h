...
public:
    ...
    public:
        ...
        operator->() const
        {
            return &buffer_.ReadBuffer(index_);
        }
        const T*
        operator*() const
        {
...
private:
    ...
    // micro-scale.
    inline bool
    IsFilledIndexByBufferIndex(size_t buffer_index) const
    {
