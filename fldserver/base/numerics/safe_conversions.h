...
#include "fldserver/base/numerics/safe_conversions_impl.h"
...
#include "fldserver/base/numerics/safe_conversions_arm_impl.h"
...
IsValueInRangeForNumericType(Src value)
{
    ...
    return internal::IsValueInRangeFastOp<Dst, SrcType>::is_supported
                   ...
                   : internal::DstRangeRelationToSrcRange<Dst>(static_cast<SrcType>(value))
                             .IsValid();
}
...
constexpr Dst
saturated_cast_impl(Src value, RangeCheck constraint)
{
...
{
    static constexpr bool value = StaticDstRangeRelationToSrcRange<Dst, Src>::value
...
template <typename T>
constexpr StrictNumeric<typename UnderlyingType<T>::type>
MakeStrictNum(const T value)
{
    return value;
}
...
template <typename T>
std::ostream&
operator<<(std::ostream& os, const StrictNumeric<T>& value)
{
...
#define BASE_NUMERIC_COMPARISON_OPERATORS(CLASS, NAME, OP)                                         \
    ...
    {                                                                                              \
        return SafeCompare<NAME,                                                                   \
                           typename UnderlyingType<L>::type,                                       \
