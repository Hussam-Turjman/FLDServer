...
#include "fldserver/base/numerics/safe_math_arm_impl.h"
...
struct CheckedAddFastOp
{
    ...
    template <typename V>
    __attribute__((always_inline)) static constexpr bool
    Do(T x, U y, V* result)
    {
...
struct ClampedAddFastOp
{
    ...
    template <typename V>
    __attribute__((always_inline)) static V
    Do(T x, U y)
    {
...
struct ClampedNegFastOp
{
    ...
    __attribute__((always_inline)) static T
    Do(T value)
    {
