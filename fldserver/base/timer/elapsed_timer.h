...
class CORE_EXPORT ElapsedTimer
{
public:
    ElapsedTimer();
...
class CORE_EXPORT ElapsedThreadTimer
{
public:
    ElapsedThreadTimer();
...
class CORE_EXPORT ScopedMockElapsedTimersForTest
{
public:
    static constexpr TimeDelta kMockElapsedTime = TimeDelta::FromMilliseconds(1337);
