...
class CORE_EXPORT dict_iterator
{
public:
    ...
    public:
        ...
        pointer&
        operator=(const pointer& ptr) = delete;
    ...
    dict_iterator&
    operator=(const dict_iterator& dict_iter);
    ~dict_iterator();
...
// access without incurring a copy.
class CORE_EXPORT const_dict_iterator
{
public:
    ...
    const_dict_iterator&
    operator=(const const_dict_iterator& dict_iter);
    ~const_dict_iterator();
...
// const-qualification.
class CORE_EXPORT dict_iterator_proxy
{
public:
...
class CORE_EXPORT const_dict_iterator_proxy
{
public:
