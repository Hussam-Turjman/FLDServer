...
#define IPC_STRUCT_TRAITS_BEGIN(struct_name)                                                       \
    ...
    {                                                                                              \
        ...
        static bool                                                                                \
        Read(const base::Pickle* m, base::PickleIterator* iter, param_type* p);                    \
        static void                                                                                \
...
#define IPC_ENUM_TRAITS(type) IPC_ENUM_TRAITS_VALIDATE(type, true)
...
#define IPC_ENUM_TRAITS_MAX_VALUE(type, maxvalue) IPC_ENUM_TRAITS_MIN_MAX_VALUE(type, 0, maxvalue)
...
#define IPC_ENUM_TRAITS_MIN_MAX_VALUE(type, minvalue, maxvalue)                                    \
    IPC_ENUM_TRAITS_VALIDATE(type,                                                                 \
                             (static_cast<int>(value) >= static_cast<int>(minvalue)                \
