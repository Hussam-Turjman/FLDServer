...
class COMPONENT_EXPORT(IPC) MessageFilter : public base::RefCountedThreadSafe<MessageFilter>
{
public:
    MessageFilter();
    ...
    virtual bool
    OnMessageReceived(const Message& message);
    ...
    virtual bool
    GetSupportedMessageClasses(std::vector<uint32_t>* supported_message_classes) const;
