...
#include "fldserver/base/ipc/message_router.h"
...
bool
MessageRouter::OnControlMessageReceived(const IPC::Message& msg)
{
...
bool
MessageRouter::Send(IPC::Message* msg)
{
...
bool
MessageRouter::AddRoute(int32_t routing_id, IPC::Listener* listener)
{
...
void
MessageRouter::RemoveRoute(int32_t routing_id)
{
    routes_.Remove(routing_id);
}

Listener*
MessageRouter::GetRoute(int32_t routing_id)
{
    return routes_.Lookup(routing_id);
}

bool
MessageRouter::OnMessageReceived(const IPC::Message& msg)
{
...
bool
MessageRouter::RouteMessage(const IPC::Message& msg)
{
