...
#include "fldserver/base/ipc/ipc_message_null_macros.h"

// STRUCT declarations cause corresponding STRUCT_TRAITS declarations to occur.
#undef IPC_STRUCT_BEGIN_WITH_PARENT
#undef IPC_STRUCT_MEMBER
#undef IPC_STRUCT_END
#define IPC_STRUCT_BEGIN_WITH_PARENT(struct_name, parent) IPC_STRUCT_TRAITS_BEGIN(struct_name)
...
#define IPC_ENUM_TRAITS_VALIDATE(enum_name, validation_expression)                                 \
    void ParamTraits<enum_name>::Write(base::Pickle* m, const param_type& value)                   \
    {                                                                                              \
