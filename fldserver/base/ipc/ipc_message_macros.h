...
//     #include "fldserver/path/to/YYY_message_generator.h"
//     // Generate constructors.
//     #include "fldserver/base/ipc/struct_constructor_macros.h"
//     #include "fldserver/path/to/YYY_message_generator.h"
//     // Generate param traits write methods.
//     #include "fldserver/base/ipc/param_traits_write_macros.h"
//     namespace IPC {
//     #include "fldserver/path/to/YYY_message_generator.h"
//     }  // namespace IPC
//     // Generate param traits read methods.
//     #include "fldserver/base/ipc/param_traits_read_macros.h"
//     namespace IPC {
//     #include "fldserver/path/to/YYY_message_generator.h"
//     }  // namespace IPC
//     // Generate param traits log methods.
//     #include "fldserver/base/ipc/param_traits_log_macros.h"
//     namespace IPC {
//     #include "fldserver/path/to/YYY_message_generator.h"
//     }  // namespace IPC
//
...
//     #define IPC_MESSAGE_IMPL
//     #include "fldserver/XXX_messages.h"
...
//      #include "fldserver/path/to/some_class.h"        // Full class declaration
//      #include "fldserver/path/to/some_other_class.h"  // Full class declaration
...
#include "fldserver/base/export_template.h"
#include "fldserver/base/hash/md5_constexpr.h"
#include "fldserver/base/location.h"
#include "fldserver/base/task/common/task_annotator.h"
#include "fldserver/ipc/ipc_message_templates.h"
#include "fldserver/base/ipc/ipc_message_utils.h"
#include "fldserver/ipc/param_traits_macros.h"
...
#define IPC_STRUCT_BEGIN(struct_name) IPC_STRUCT_BEGIN_WITH_PARENT(struct_name, IPC::NoParams)
...
#define IPC_MESSAGE_EXTRA(msg_name)                                                                \
    ...
    template class EXPORT_TEMPLATE_DEFINE(IPC_MESSAGE_EXPORT) IPC::MessageT<msg_name##_Meta>;

#define IPC_MESSAGE_DEFINE_KIND(msg_name) const IPC::MessageKind msg_name##_Meta::kKind;
...
#define IPC_MESSAGE_FORWARD(msg_class, obj, member_func)                                           \
    case msg_class::ID: {                                                                          \
        ...
        if (!msg_class::Dispatch(&ipc_message__, obj, this, param__, &member_func))                \
...
#define IPC_MESSAGE_FORWARD_DELAY_REPLY(msg_class, obj, member_func)                               \
    case msg_class::ID: {                                                                          \
        IPC_TASK_ANNOTATOR_CONTEXT(msg_class)                                                      \
        if (!msg_class::DispatchDelayReply(&ipc_message__, obj, param__, &member_func))            \
            ipc_message__.set_dispatch_error();                                                    \
    }                                                                                              \
    break;
...
#define IPC_MESSAGE_FORWARD_WITH_PARAM_DELAY_REPLY(msg_class, obj, member_func)                    \
    case msg_class::ID: {                                                                          \
        IPC_TASK_ANNOTATOR_CONTEXT(msg_class)                                                      \
        if (!msg_class::DispatchWithParamDelayReply(                                               \
...
#define IPC_MESSAGE_CONTROL4(msg, a, b, c, d) IPC_MESSAGE_CONTROL(msg, a, b, c, d)
#define IPC_MESSAGE_CONTROL5(msg, a, b, c, d, e) IPC_MESSAGE_CONTROL(msg, a, b, c, d, e)
...
#define IPC_SYNC_MESSAGE_CONTROL0_1(msg, a) IPC_SYNC_MESSAGE_CONTROL(msg, (), (a))
#define IPC_SYNC_MESSAGE_CONTROL0_2(msg, a, b) IPC_SYNC_MESSAGE_CONTROL(msg, (), (a, b))
#define IPC_SYNC_MESSAGE_CONTROL0_3(msg, a, b, c) IPC_SYNC_MESSAGE_CONTROL(msg, (), (a, b, c))
#define IPC_SYNC_MESSAGE_CONTROL0_4(msg, a, b, c, d) IPC_SYNC_MESSAGE_CONTROL(msg, (), (a, b, c, d))
#define IPC_SYNC_MESSAGE_CONTROL1_0(msg, a) IPC_SYNC_MESSAGE_CONTROL(msg, (a), ())
#define IPC_SYNC_MESSAGE_CONTROL1_1(msg, a, b) IPC_SYNC_MESSAGE_CONTROL(msg, (a), (b))
#define IPC_SYNC_MESSAGE_CONTROL1_2(msg, a, b, c) IPC_SYNC_MESSAGE_CONTROL(msg, (a), (b, c))
#define IPC_SYNC_MESSAGE_CONTROL1_3(msg, a, b, c, d) IPC_SYNC_MESSAGE_CONTROL(msg, (a), (b, c, d))
#define IPC_SYNC_MESSAGE_CONTROL1_4(msg, a, b, c, d, e)                                            \
    IPC_SYNC_MESSAGE_CONTROL(msg, (a), (b, c, d, e))
#define IPC_SYNC_MESSAGE_CONTROL2_0(msg, a, b) IPC_SYNC_MESSAGE_CONTROL(msg, (a, b), ())
#define IPC_SYNC_MESSAGE_CONTROL2_1(msg, a, b, c) IPC_SYNC_MESSAGE_CONTROL(msg, (a, b), (c))
#define IPC_SYNC_MESSAGE_CONTROL2_2(msg, a, b, c, d) IPC_SYNC_MESSAGE_CONTROL(msg, (a, b), (c, d))
...
#define IPC_SYNC_MESSAGE_CONTROL3_0(msg, a, b, c) IPC_SYNC_MESSAGE_CONTROL(msg, (a, b, c), ())
#define IPC_SYNC_MESSAGE_CONTROL3_1(msg, a, b, c, d) IPC_SYNC_MESSAGE_CONTROL(msg, (a, b, c), (d))
...
#define IPC_SYNC_MESSAGE_CONTROL4_0(msg, a, b, c, d) IPC_SYNC_MESSAGE_CONTROL(msg, (a, b, c, d), ())
...
#define IPC_SYNC_MESSAGE_ROUTED0_2(msg, a, b) IPC_SYNC_MESSAGE_ROUTED(msg, (), (a, b))
#define IPC_SYNC_MESSAGE_ROUTED0_3(msg, a, b, c) IPC_SYNC_MESSAGE_ROUTED(msg, (), (a, b, c))
#define IPC_SYNC_MESSAGE_ROUTED0_4(msg, a, b, c, d) IPC_SYNC_MESSAGE_ROUTED(msg, (), (a, b, c, d))
#define IPC_SYNC_MESSAGE_ROUTED1_0(msg, a) IPC_SYNC_MESSAGE_ROUTED(msg, (a), ())
#define IPC_SYNC_MESSAGE_ROUTED1_1(msg, a, b) IPC_SYNC_MESSAGE_ROUTED(msg, (a), (b))
#define IPC_SYNC_MESSAGE_ROUTED1_2(msg, a, b, c) IPC_SYNC_MESSAGE_ROUTED(msg, (a), (b, c))
#define IPC_SYNC_MESSAGE_ROUTED1_3(msg, a, b, c, d) IPC_SYNC_MESSAGE_ROUTED(msg, (a), (b, c, d))
#define IPC_SYNC_MESSAGE_ROUTED1_4(msg, a, b, c, d, e)                                             \
    IPC_SYNC_MESSAGE_ROUTED(msg, (a), (b, c, d, e))
#define IPC_SYNC_MESSAGE_ROUTED2_0(msg, a, b) IPC_SYNC_MESSAGE_ROUTED(msg, (a, b), ())
#define IPC_SYNC_MESSAGE_ROUTED2_1(msg, a, b, c) IPC_SYNC_MESSAGE_ROUTED(msg, (a, b), (c))
#define IPC_SYNC_MESSAGE_ROUTED2_2(msg, a, b, c, d) IPC_SYNC_MESSAGE_ROUTED(msg, (a, b), (c, d))
...
#define IPC_SYNC_MESSAGE_ROUTED3_0(msg, a, b, c) IPC_SYNC_MESSAGE_ROUTED(msg, (a, b, c), ())
#define IPC_SYNC_MESSAGE_ROUTED3_1(msg, a, b, c, d) IPC_SYNC_MESSAGE_ROUTED(msg, (a, b, c), (d))
...
#define IPC_SYNC_MESSAGE_ROUTED4_0(msg, a, b, c, d) IPC_SYNC_MESSAGE_ROUTED(msg, (a, b, c, d), ())
