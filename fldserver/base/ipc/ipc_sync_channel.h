...
#include "fldserver/base/synchronization/waitable_event_watcher.h"
...
#include "fldserver/base/ipc/ipc_sync_message_filter.h"
...
public:
    ...
    static std::unique_ptr<SyncChannel>
    ...
    void
    SetRestrictDispatchChannelGroup(int group);
...
protected:
    ...
    public:
        ...
        bool
        TryToUnblockListener(const Message* msg);
        ...
        void
        set_restrict_dispatch_group(int group)
        {
            restrict_dispatch_group_ = group;
        }

        int
        restrict_dispatch_group() const
        {
            return restrict_dispatch_group_;
        }

        void
        OnSendDoneEventSignaled(base::RunLoop* nested_loop, base::WaitableEvent* event);
    ...
    private:
        ...
        bool
        OnMessageReceived(const Message& msg) override;
        void
        OnChannelError() override;
        void
        OnChannelOpened() override;
        void
        OnChannelClosed() override;
        ...
        void
        OnShutdownEventSignaled(base::WaitableEvent* event);
...
private:
    ...
    void
    OnDispatchEventSignaled(base::WaitableEvent* event);
    ...
    static void
    WaitForReply(mojo::SyncHandleRegistry* registry, SyncContext* context);
