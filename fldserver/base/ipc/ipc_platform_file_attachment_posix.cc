...
namespace internal
{
PlatformFileAttachment::PlatformFileAttachment(base::PlatformFile file) : file_(file)
{
}
...
PlatformFileAttachment::GetType() const
{
    return Type::PLATFORM_FILE;
}

base::PlatformFile
PlatformFileAttachment::TakePlatformFile()
{
...
base::PlatformFile
GetPlatformFile(scoped_refptr<MessageAttachment> attachment)
{
