...
{
bool
TryFiltersImpl(MessageFilterRouter::MessageFilters& filters, const IPC::Message& message)
{
...
bool
RemoveFilterImpl(MessageFilterRouter::MessageFilters& filters, MessageFilter* filter)
{
...
bool
ValidMessageClass(int message_class)
{
...
void
MessageFilterRouter::AddFilter(MessageFilter* filter)
{
...
void
MessageFilterRouter::RemoveFilter(MessageFilter* filter)
{
...
bool
MessageFilterRouter::TryFilters(const Message& message)
{
