...
SyncMessage::SyncMessage(int32_t routing_id,
    ...
    Message(routing_id, type, priority), deserializer_(deserializer)
{
    set_sync();
    set_unblock(true);
...
bool
SyncMessage::IsMessageReplyTo(const Message& msg, int request_id)
{
    if (!msg.is_reply())
        return false;
...
base::PickleIterator
SyncMessage::GetDataIterator(const Message* msg)
{
...
int
SyncMessage::GetMessageId(const Message& msg)
{
...
Message*
SyncMessage::GenerateReply(const Message* msg)
{
    DCHECK(msg->is_sync());
...
bool
SyncMessage::ReadSyncHeader(const Message& msg, SyncHeader* header)
{
...
bool
SyncMessage::WriteSyncHeader(Message* msg, const SyncHeader& header)
{
    DCHECK(msg->is_sync() || msg->is_reply());
...
bool
MessageReplyDeserializer::SerializeOutputParameters(const Message& msg)
{
