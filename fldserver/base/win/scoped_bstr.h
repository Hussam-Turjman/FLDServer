...
public:
    ...
    void
    SetByteLen(size_t bytes);

    // Swap values of two ScopedBstr's.
    void
    Swap(ScopedBstr& bstr2);
    ...
    bool
    operator==(const ScopedBstr& bstr2) const = delete;
    bool
    operator!=(const ScopedBstr& bstr2) const = delete;
