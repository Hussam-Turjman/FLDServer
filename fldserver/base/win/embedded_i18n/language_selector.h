...
class CORE_EXPORT LanguageSelector
{
public:
    ...
    // are available.
    LanguageSelector(WStringPiece preferred_language, span<const LangToOffset> languages_to_offset);
