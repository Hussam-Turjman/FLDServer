...
// clang-format off
#include "fldserver/base/win/winrt_storage_util.h"
...
HRESULT
GetPointerToBufferData(IBuffer* buffer, uint8_t** out, UINT32* length)
{
    *out = nullptr;
...
HRESULT
CreateIBufferFromData(const uint8_t* data, UINT32 length, Microsoft::WRL::ComPtr<IBuffer>* buffer)
{
    *buffer = nullptr;

    Microsoft::WRL::ComPtr<ABI::Windows::Storage::Streams::IBufferFactory> buffer_factory;
    HRESULT hr = base::win::GetActivationFactory<ABI::Windows::Storage::Streams::IBufferFactory,
