...
#define CALLBACK __stdcall
    ...
    TryAcquireSRWLockExclusive(_Inout_ PSRWLOCK SRWLock);

    // Needed to support protobuf's GetMessage macro magic.
    WINUSERAPI BOOL WINAPI
    GetMessageW(_Out_ LPMSG lpMsg,
                _In_opt_ HWND hWnd,
    ...
    TlsGetValue(_In_ DWORD dwTlsIndex);
    ...
    WINBASEAPI HLOCAL WINAPI
    LocalFree(_In_ HLOCAL hMem);
#endif
#ifdef __cplusplus
}
#endif
