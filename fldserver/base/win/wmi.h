...
CORE_EXPORT bool
CreateLocalWmiConnection(bool set_blanket, Microsoft::WRL::ComPtr<IWbemServices>* wmi_services);
...
// registry.
class CORE_EXPORT WmiComputerSystemInfo
{
public:
    static WmiComputerSystemInfo
    Get();
...
private:
    void
    PopulateSerialNumber(const Microsoft::WRL::ComPtr<IWbemServices>& services);
