...
DWORD
ComInitBalancer::GetReferenceCountForTesting() const
{
...
IFACEMETHODIMP
ComInitBalancer::PostInitialize(HRESULT result, DWORD apartment_type, DWORD new_reference_count)
{
