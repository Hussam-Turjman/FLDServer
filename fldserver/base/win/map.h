...
#include "fldserver/base/win/vector.h"
#include "fldserver/base/win/winrt_foundation_helpers.h"
...
template <typename K, typename V>
using ComplexK = typename ABI::Windows::Foundation::Collections::IMap<K, V>::K_complex;

template <typename K, typename V>
using ComplexV = typename ABI::Windows::Foundation::Collections::IMap<K, V>::V_complex;
...
class KeyValuePair
    : public Microsoft::WRL::RuntimeClass<
              ...
              ABI::Windows::Foundation::Collections::IKeyValuePair<LogicalK<K, V>, LogicalV<K, V>>>
{
public:
    using AbiK = AbiK<K, V>;
    using AbiV = AbiV<K, V>;
    ...
    KeyValuePair(StorageK key, StorageV value) : key_(std::move(key)), value_(std::move(value))
    {
    }
    ...
    get_Key(AbiK* key)
    {
        return CopyTo(key_, key);
    }

    IFACEMETHODIMP
    get_Value(AbiV* value)
    {
        return CopyTo(value_, value);
    }
...
{
public:
    MapChangedEventArgs(ABI::Windows::Foundation::Collections::CollectionChange change, K key) :
    ...
    IFACEMETHODIMP
    get_CollectionChange(ABI::Windows::Foundation::Collections::CollectionChange* value) override
    {
        *value = change_;
        return S_OK;
    }
...
class Map
    : public Microsoft::WRL::RuntimeClass<
              ...
              ABI::Windows::Foundation::Collections::IObservableMap<internal::LogicalK<K, V>,
                                                                    internal::LogicalV<K, V>>,
              ABI::Windows::Foundation::Collections::IIterable<
                      ABI::Windows::Foundation::Collections::
                              IKeyValuePair<internal::LogicalK<K, V>, internal::LogicalV<K, V>>*>>
{
public:
...
private:
    ...
    {
    public:
        explicit MapIterator(Microsoft::WRL::ComPtr<MapView> view) : view_(std::move(view))
        {
        ...
        // ABI::Windows::Foundation::Collections::IIterator:
        IFACEMETHODIMP
        get_Current(ABI::Windows::Foundation::Collections::IKeyValuePair<LogicalK, LogicalV>**
                            current) override
        {
            return view_->ValidState() ? iterator_->get_Current(current) : E_CHANGED_STATE;
        }

        IFACEMETHODIMP
        get_HasCurrent(boolean* has_current) override
        {
            return view_->ValidState() ? iterator_->get_HasCurrent(has_current) : E_CHANGED_STATE;
        }

        IFACEMETHODIMP
        MoveNext(boolean* has_current) override
        {
            return view_->ValidState() ? iterator_->MoveNext(has_current) : E_CHANGED_STATE;
        }

        IFACEMETHODIMP
        GetMany(unsigned capacity,
                ABI::Windows::Foundation::Collections::IKeyValuePair<LogicalK, LogicalV>** value,
    ...
    private:
        ...
        ConvertMapToVectorIterator()
        {
            ...
            auto vector = Microsoft::WRL::Make<Vector<
                    ABI::Windows::Foundation::Collections::IKeyValuePair<LogicalK, LogicalV>*>>();

            // Fill the vector with container data.
            for (const auto& pair : view_->get_map())
            {
                auto key_value_pair = Microsoft::WRL::Make<internal::KeyValuePair<AbiK, AbiV>>(
    ...
    class MapView
        : public Microsoft::WRL::RuntimeClass<
                  Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::WinRtClassicComMix
                                                    | Microsoft::WRL::InhibitRoOriginateError>,
                  ABI::Windows::Foundation::Collections::IMapView<internal::LogicalK<K, V>,
                                                                  internal::LogicalV<K, V>>,
                  ABI::Windows::Foundation::Collections::IIterable<
                          ABI::Windows::Foundation::Collections::IKeyValuePair<
                                  internal::LogicalK<K, V>,
    ...
    {
    public:
        explicit MapView(Microsoft::WRL::ComPtr<Map<LogicalK, LogicalV>> map) : map_(std::move(map))
        {
        ...
        IFACEMETHODIMP
        Lookup(AbiK key, AbiV* value) override
        {
            return map_ ? map_->Lookup(key, value) : E_CHANGED_STATE;
        }

        IFACEMETHODIMP
        get_Size(unsigned int* size) override
        {
            return map_ ? map_->get_Size(size) : E_CHANGED_STATE;
        }

        IFACEMETHODIMP
        HasKey(AbiK key, boolean* found) override
        {
            return map_ ? map_->HasKey(key, found) : E_CHANGED_STATE;
        }

        IFACEMETHODIMP
        Split(ABI::Windows::Foundation::Collections::IMapView<LogicalK, LogicalV>** first_partition,
        ...
        // ABI::Windows::Foundation::Collections::IIterable:
        IFACEMETHODIMP
        First(ABI::Windows::Foundation::Collections::IIterator<
                ABI::Windows::Foundation::Collections::IKeyValuePair<LogicalK, LogicalV>*>** first)
                override
        {
        ...
        // ABI::Windows::Foundation::Collections::MapChangedEventHandler:
        IFACEMETHODIMP
        Invoke(ABI::Windows::Foundation::Collections::IObservableMap<LogicalK, LogicalV>* sender,
               ABI::Windows::Foundation::Collections::IMapChangedEventArgs<LogicalK>* e) override
        {
        ...
        const std::map<StorageK, StorageV, internal::Less>&
        get_map()
        {
            DCHECK(map_);
            return map_->map_;
...
public:
    Map() = default;
    explicit Map(const std::map<StorageK, StorageV, internal::Less>& map) : map_(map)
    {
    }
    explicit Map(std::map<StorageK, StorageV, internal::Less>&& map) : map_(std::move(map))
    {
    }
    ...
    IFACEMETHODIMP
    GetView(ABI::Windows::Foundation::Collections::IMapView<LogicalK, LogicalV>** view) override
    {
        return Microsoft::WRL::Make<MapView>(this).CopyTo(view);
    }

    IFACEMETHODIMP
    Insert(AbiK key, AbiV value, boolean* replaced) override
    {
        *replaced = !InsertOrAssign(map_, key, std::move(value)).second;
        NotifyMapChanged(
                *replaced ? ABI::Windows::Foundation::Collections::CollectionChange_ItemChanged
    ...
    IFACEMETHODIMP
    Remove(AbiK key) override
    {
        if (!map_.erase(key))
            return E_BOUNDS;

        NotifyMapChanged(ABI::Windows::Foundation::Collections::CollectionChange_ItemRemoved, key);
        return S_OK;
    }
    ...
    {
        map_.clear();
        NotifyMapChanged(ABI::Windows::Foundation::Collections::CollectionChange_Reset,
    ...
    IFACEMETHODIMP
    add_MapChanged(ABI::Windows::Foundation::Collections::MapChangedEventHandler<LogicalK,
                                                                                 LogicalV>* handler,
    ...
    IFACEMETHODIMP
    remove_MapChanged(EventRegistrationToken token) override
    {
    ...
    First(ABI::Windows::Foundation::Collections::IIterator<
            ...
            override
    {
        return Microsoft::WRL::Make<MapIterator>(Microsoft::WRL::Make<MapView>(this)).CopyTo(first);
    }
...
private:
    ...
    void
    NotifyMapChanged(ABI::Windows::Foundation::Collections::CollectionChange change, AbiK key)
    {
        auto args = Microsoft::WRL::Make<internal::MapChangedEventArgs<AbiK>>(change, key);
    ...
    base::flat_map<
            int64_t,
            ABI::Windows::Foundation::Collections::MapChangedEventHandler<LogicalK, LogicalV>*>
            handlers_;
