...
ToCString(AsyncStatus async_status)
{
    switch (async_status)
    {
        case AsyncStatus::Started: return "AsyncStatus::Started";
        case AsyncStatus::Completed: return "AsyncStatus::Completed";
        case AsyncStatus::Canceled: return "AsyncStatus::Canceled";
        case AsyncStatus::Error: return "AsyncStatus::Error";
    }
...
template <typename T>
HRESULT
GetAsyncResultsT(IAsyncOperationT<T>* async_operation,
...
template <typename T>
HRESULT
PostAsyncOperationCompletedHandler(IAsyncOperationT<T>* async_operation,
                                   IAsyncOperationCompletedHandlerT<T> completed_handler)
{
    ...
    return async_operation->put_Completed(
            Microsoft::WRL::Callback<CompletedHandler>([internal_completed_handler(std::move(
                                                               internal_completed_handler))](
                                                               IAsyncOperationT<T>* async_operation,
                                                               AsyncStatus async_status) mutable {
                return std::move(internal_completed_handler).Run(async_operation, async_status);
            }).Get());
}
...
template <typename T>
HRESULT
PostAsyncHandlers(internal::IAsyncOperationT<T>* async_operation,
            ...
            base::BindOnce(
                    [](base::OnceCallback<void(internal::AsyncResultsT<T>)> success_callback,
                       ...
                       AsyncStatus async_status) {
                        ...
                        HRESULT hr =
                                internal::GetAsyncResultsT(async_operation, async_status, &results);
                        if (SUCCEEDED(hr))
...
PostAsyncHandlers(internal::IAsyncOperationT<T>* async_operation,
                  base::OnceCallback<void(internal::AsyncResultsT<T>)> success_callback,
                  base::OnceCallback<void(HRESULT, internal::AsyncResultsT<T>)> failure_callback)
{
    return internal::PostAsyncOperationCompletedHandler(
            async_operation,
            base::BindOnce(
                    [](base::OnceCallback<void(internal::AsyncResultsT<T>)> success_callback,
                       ...
                       AsyncStatus async_status) {
                        ...
                        HRESULT hr = internal::GetAsyncResultsT(async_operation,
                                                                async_status == AsyncStatus::Error
...
template <typename T>
HRESULT
PostAsyncResults(Microsoft::WRL::ComPtr<internal::IAsyncOperationT<T>> async_operation,
