...
{
bool
GetResourceFromModule(
        HMODULE module, int resource_id, LPCTSTR resource_type, void** data, size_t* length)
{
    if (!module)
        return false;
    ...
    HRSRC hres_info = FindResource(module, MAKEINTRESOURCE(resource_id), resource_type);
...
bool
GetDataResourceFromModule(HMODULE module, int resource_id, void** data, size_t* length)
{
