...
public:
    ...
    static WOW64Status
    GetWOW64StatusForProcess(HANDLE process_handle);
    ...
    Version
    Kernel32Version() const;
    VersionNumber
    Kernel32VersionNumber() const;
    base::Version
    Kernel32BaseVersion() const;
...
private:
    ...
    static Version
    MajorMinorBuildToVersion(int major, int minor, int build);
