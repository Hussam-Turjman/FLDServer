...
inline HANDLE
Uint32ToHandle(uint32_t h)
{
    return reinterpret_cast<HANDLE>(static_cast<uintptr_t>(static_cast<int32_t>(h)));
}
...
CORE_EXPORT bool
PinUser32(NativeLibraryLoadError* error = nullptr);
...
// cached.
CORE_EXPORT void*
GetUser32FunctionPointer(const char* function_name, NativeLibraryLoadError* error = nullptr);
...
class CORE_EXPORT ScopedDomainStateForTesting
{
public:
...
class CORE_EXPORT ScopedDeviceRegisteredWithManagementForTesting
{
public:
