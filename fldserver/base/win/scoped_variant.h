...
class CORE_EXPORT ScopedVariant
{
public:
    ...
    void
    Reset(const VARIANT& var = kEmptyVariant);
...
private:
    ...
    bool
    operator==(const ScopedVariant& var) const;
    bool
    operator!=(const ScopedVariant& var) const;
