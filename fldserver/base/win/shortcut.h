...
struct CORE_EXPORT ShortcutProperties
{
    enum IndividualProperties
    {
        ...
        PROPERTIES_ALL = PROPERTIES_TARGET | PROPERTIES_WORKING_DIR | PROPERTIES_ARGUMENTS
    ...
    void
    set_target(const FilePath& target_in)
    {
        target = target_in;
    ...
    void
    set_working_dir(const FilePath& working_dir_in)
    {
    ...
    void
    set_arguments(const std::wstring& arguments_in)
    {
    ...
    void
    set_description(const std::wstring& description_in)
    {
    ...
    void
    set_icon(const FilePath& icon_in, int icon_index_in)
    {
        icon = icon_in;
    ...
    void
    set_app_id(const std::wstring& app_id_in)
    {
        app_id = app_id_in;
    ...
    void
    set_dual_mode(bool dual_mode_in)
    {
    ...
    void
    set_toast_activator_clsid(const CLSID& toast_activator_clsid_in)
    {
