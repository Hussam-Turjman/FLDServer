...
public:
    ...
    GenericScopedHandle&
    operator=(GenericScopedHandle&& other)
    {
...
public:
    ...
    static void
    StartTracking(HANDLE handle, const void* owner, const void* pc1, const void* pc2)
    {
    }
    static void
    StopTracking(HANDLE handle, const void* owner, const void* pc1, const void* pc2)
    {
    }
...
class CORE_EXPORT VerifierTraits
{
public:
    using Handle = HANDLE;
...
CORE_EXPORT void
OnHandleBeingClosed(HANDLE handle);
}  // namespace win
}  // namespace base
