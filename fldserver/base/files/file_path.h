...
public:
    ...
    // unspecified state.
    FilePath&
    operator=(FilePath&& that) noexcept;

    bool
    operator==(const FilePath& that) const;
    ...
    static bool
    IsSeparator(CharType character);
    ...
    void
    GetComponents(std::vector<FilePath::StringType>* components) const;
    ...
    // own parent.
    bool
    IsParent(const FilePath& child) const;
    ...
    // returns false.
    bool
    AppendRelativePath(const FilePath& child, FilePath* path) const;
    ...
    StringType
    FinalExtension() const WARN_UNUSED_RESULT;
    ...
    FilePath
    InsertBeforeExtension(StringPieceType suffix) const WARN_UNUSED_RESULT;
    FilePath
    InsertBeforeExtensionASCII(StringPiece suffix) const WARN_UNUSED_RESULT;

    // Adds |extension| to |file_name|. Returns the current FilePath if
    // |extension| is empty. Returns "" if BaseName() == "." or "..".
    FilePath
    AddExtension(StringPieceType extension) const WARN_UNUSED_RESULT;

    // Like above, but takes the extension as an ASCII string. See AppendASCII for
    // details on how this is handled.
    FilePath
    AddExtensionASCII(StringPiece extension) const WARN_UNUSED_RESULT;
    ...
    FilePath
    ReplaceExtension(StringPieceType extension) const WARN_UNUSED_RESULT;

    // Returns true if the file path matches the specified extension. The test is
    // case insensitive. Don't forget the leading period if appropriate.
    bool
    MatchesExtension(StringPieceType extension) const;
    ...
    FilePath
    Append(StringPieceType component) const WARN_UNUSED_RESULT;
    FilePath
    Append(const FilePath& component) const WARN_UNUSED_RESULT;
    ...
    FilePath
    AppendASCII(StringPiece component) const WARN_UNUSED_RESULT;
    ...
    bool
    EndsWithSeparator() const WARN_UNUSED_RESULT;
    ...
    static FilePath
    FromUTF8Unsafe(StringPiece utf8);

    // Similar to FromUTF8Unsafe, but accepts UTF-16 instead.
    static FilePath
    FromUTF16Unsafe(StringPiece16 utf16);

    void
    WriteToPickle(Pickle* pickle) const;
    bool
    ReadFromPickle(PickleIterator* iter);
    ...
    // (if FILE_PATH_USES_WIN_SEPARATORS is true), or do nothing on POSIX systems.
    FilePath
    NormalizePathSeparatorsTo(CharType separator) const;
    ...
    static int
    CompareIgnoreCase(StringPieceType string1, StringPieceType string2);
    static bool
    CompareEqualIgnoreCase(StringPieceType string1, StringPieceType string2)
    {
        return CompareIgnoreCase(string1, string2) == 0;
    }
    static bool
    CompareLessIgnoreCase(StringPieceType string1, StringPieceType string2)
    {
        return CompareIgnoreCase(string1, string2) < 0;
    }
    ...
    static StringType
    GetHFSDecomposedForm(StringPieceType string);
    ...
    static int
    HFSFastUnicodeCompare(StringPieceType string1, StringPieceType string2);
#endif
...
struct hash<base::FilePath>
{
    ...
    result_type
    operator()(argument_type const& f) const
    {
