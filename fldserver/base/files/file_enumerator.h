...
//     ...
class CORE_EXPORT FileEnumerator
{
public:
...
private:
    ...
    bool
    ShouldSkip(const FilePath& path);

    bool
    IsTypeMatched(bool is_dir) const;

    bool
    IsPatternMatched(const FilePath& src) const;
