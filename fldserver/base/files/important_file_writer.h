...
class CORE_EXPORT ImportantFileWriter
{
public:
    ...
    class CORE_EXPORT DataSerializer
    {
    public:
        ...
        virtual bool
        SerializeData(std::string* data) = 0;
    ...
    class CORE_EXPORT BackgroundDataSerializer
    {
    public:
    ...
    static bool
    WriteFileAtomically(const FilePath& path,
                        StringPiece data,
    ...
    ImportantFileWriter&
    operator=(const ImportantFileWriter&) = delete;
    ...
    // ImportantFileWriter.
    void
    ScheduleWrite(DataSerializer* serializer);

    // Same as above but uses the BackgroundDataSerializer API.
    void
    ScheduleWriteWithBackgroundDataSerializer(BackgroundDataSerializer* serializer);
    ...
    void
    RegisterOnNextWriteCallbacks(OnceClosure before_next_write_callback,
    ...
    void
    SetTimerForTesting(OneShotTimer* timer_override);

#if defined(UNIT_TEST)
    size_t
    previous_data_size() const
    {
        return previous_data_size_;
    }
#endif
    void
    set_previous_data_size(size_t previous_data_size)
    {
...
private:
    ...
    void
    WriteNowWithBackgroundDataProducer(BackgroundDataProducerCallback background_producer);
    ...
    static bool
    WriteFileAtomicallyImpl(const FilePath& path,
                            StringPiece data,
    ...
    absl::variant<absl::monostate, DataSerializer*, BackgroundDataSerializer*> serializer_;
