...
public:
    ...
    static void
    AddDirectory(const FilePath& directory);
    ...
    base::Time
    GetUpperBoundTimeForTest() const;
...
private:
    ...
    void
    AddDirectoryImpl(const FilePath& directory);
    ...
    static bool
    CleanInBackground(Time upper_bound_time,
    ...
    void
    OnBackgroundTaskFinished(bool processing_completed);
    ...
    flat_set<FilePath> important_directories_ GUARDED_BY_CONTEXT(sequence_checker_);
    ...
    std::vector<FilePath> pending_directories_ GUARDED_BY_CONTEXT(sequence_checker_);
