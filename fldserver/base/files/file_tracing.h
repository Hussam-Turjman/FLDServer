...
public:
    ...
    public:
        ...
        virtual bool
        FileTracingCategoryIsEnabled() const = 0;

        // Enables file tracing for |id|. Must be called before recording events.
        virtual void
        FileTracingEnable(const void* id) = 0;

        // Disables file tracing for |id|.
        virtual void
        FileTracingDisable(const void* id) = 0;
        ...
        virtual void
        FileTracingEventBegin(const char* name,
                              const void* id,
                              const FilePath& path,
                              int64_t size) = 0;
        ...
        virtual void
        FileTracingEventEnd(const char* name, const void* id) = 0;
    };
    ...
    public:
        ...
        ScopedTrace&
        operator=(const ScopedTrace&) = delete;
        ~ScopedTrace();
        ...
        void
        Initialize(const char* name, const File* file, int64_t size);
    ...
    FileTracing&
    operator=(const FileTracing&) = delete;
};
